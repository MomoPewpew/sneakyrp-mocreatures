...
public class MoCModelCricket
  ...
  public MoCModelCricket() {
    ...
    this.Antenna.addBox(-1.0F, 0.0F, 0.0F, 2, 2, 0);
    ...
    this.AntennaB.addBox(-1.0F, 0.0F, 0.0F, 2, 2, 0);
    this.AntennaB.setRotationPoint(0.0F, 20.7F, -3.8F);
    ...
    this.Abdomen.addBox(-1.0F, 0.0F, -1.0F, 2, 3, 2);
    ...
    this.TailA.addBox(-1.0F, 0.0F, 0.0F, 2, 3, 0);
    this.TailA.setRotationPoint(0.0F, 22.0F, 2.8F);
    setRotation(this.TailA, 1.308687F, 0.0F, 0.0F);

    this.TailB = new ModelRenderer(this, 4, 7);
    this.TailB.addBox(-1.0F, 0.0F, 0.0F, 2, 2, 0);
    this.TailB.setRotationPoint(0.0F, 23.0F, 2.8F);
    ...
    this.MidLegs.addBox(-2.0F, 0.0F, 0.0F, 4, 2, 0);
    ...
    this.ThighLeft.addBox(0.0F, -3.0F, 0.0F, 1, 3, 1);
    this.ThighLeft.setRotationPoint(0.5F, 23.0F, 0.0F);
    setRotation(this.ThighLeft, -0.4886922F, 0.2617994F, 0.0F);

    this.ThighLeftB = new ModelRenderer(this, 8, 5);
    this.ThighLeftB.addBox(0.0F, -3.0F, 0.0F, 1, 3, 1);
    this.ThighLeftB.setRotationPoint(0.5F, 22.5F, 0.0F);
    setRotation(this.ThighLeftB, -1.762782F, 0.0F, 0.0F);

    this.ThighRight = new ModelRenderer(this, 12, 5);
    this.ThighRight.addBox(-1.0F, -3.0F, 0.0F, 1, 3, 1);
    this.ThighRight.setRotationPoint(-0.5F, 23.0F, 0.0F);
    setRotation(this.ThighRight, -0.4886922F, -0.2617994F, 0.0F);

    this.ThighRightB = new ModelRenderer(this, 12, 5);
    this.ThighRightB.addBox(-1.0F, -3.0F, 0.0F, 1, 3, 1);
    this.ThighRightB.setRotationPoint(-0.5F, 22.5F, 0.0F);
    setRotation(this.ThighRightB, -1.762782F, 0.0F, 0.0F);

    this.LegLeft = new ModelRenderer(this, 0, 15);
    this.LegLeft.addBox(0.0F, 0.0F, -1.0F, 0, 3, 2);
    this.LegLeft.setRotationPoint(2.0F, 21.0F, 2.5F);

    this.LegLeftB = new ModelRenderer(this, 4, 15);
    this.LegLeftB.addBox(0.0F, 0.0F, -1.0F, 0, 3, 2);
    this.LegLeftB.setRotationPoint(1.5F, 23.0F, 2.9F);
    setRotation(this.LegLeftB, 1.249201F, 0.0F, 0.0F);

    this.LegRight = new ModelRenderer(this, 4, 15);
    this.LegRight.addBox(0.0F, 0.0F, -1.0F, 0, 3, 2);
    this.LegRight.setRotationPoint(-2.0F, 21.0F, 2.5F);

    this.LegRightB = new ModelRenderer(this, 4, 15);
    this.LegRightB.addBox(0.0F, 0.0F, -1.0F, 0, 3, 2);
    this.LegRightB.setRotationPoint(-1.5F, 23.0F, 2.9F);
    setRotation(this.LegRightB, 1.249201F, 0.0F, 0.0F);

    this.LeftWing = new ModelRenderer(this, 0, 30);
    this.LeftWing.addBox(0.0F, 0.0F, -1.0F, 6, 0, 2);
    this.LeftWing.setRotationPoint(0.0F, 20.9F, -1.0F);
    setRotation(this.LeftWing, 0.0F, -0.1919862F, 0.0F);

    this.RightWing = new ModelRenderer(this, 0, 28);
    this.RightWing.addBox(-6.0F, 0.0F, -1.0F, 6, 0, 2);
    this.RightWing.setRotationPoint(0.0F, 20.9F, -1.0F);
    setRotation(this.RightWing, 0.0F, 0.1919862F, 0.0F);

    this.FoldedWings = new ModelRenderer(this, 0, 26);
    this.FoldedWings.addBox(0.0F, 0.0F, -1.0F, 6, 0, 2);
    this.FoldedWings.setRotationPoint(0.0F, 20.9F, -2.0F);
