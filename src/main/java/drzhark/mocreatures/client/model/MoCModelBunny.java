...
public class MoCModelBunny
  ...
  public MoCModelBunny() {
    ...
    this.part1.addBox(-2.0F, -1.0F, -4.0F, 4, 4, 6, 0.0F);
    this.part1.setRotationPoint(0.0F, (-1 + byte0), -4.0F);
    this.part8 = new ModelRenderer(this, 14, 0);
    this.part8.addBox(-2.0F, -5.0F, -3.0F, 1, 4, 2, 0.0F);
    this.part8.setRotationPoint(0.0F, (-1 + byte0), -4.0F);
    this.part9 = new ModelRenderer(this, 14, 0);
    this.part9.addBox(1.0F, -5.0F, -3.0F, 1, 4, 2, 0.0F);
    this.part9.setRotationPoint(0.0F, (-1 + byte0), -4.0F);
    this.part10 = new ModelRenderer(this, 20, 0);
    this.part10.addBox(-4.0F, 0.0F, -3.0F, 2, 3, 2, 0.0F);
    this.part10.setRotationPoint(0.0F, (-1 + byte0), -4.0F);
    this.part11 = new ModelRenderer(this, 20, 0);
    this.part11.addBox(2.0F, 0.0F, -3.0F, 2, 3, 2, 0.0F);
    this.part11.setRotationPoint(0.0F, (-1 + byte0), -4.0F);
    this.part2 = new ModelRenderer(this, 0, 10);
    this.part2.addBox(-3.0F, -4.0F, -3.0F, 6, 8, 6, 0.0F);
    this.part2.setRotationPoint(0.0F, (0 + byte0), 0.0F);
    this.part3 = new ModelRenderer(this, 0, 24);
    this.part3.addBox(-2.0F, 4.0F, -2.0F, 4, 3, 4, 0.0F);
    this.part3.setRotationPoint(0.0F, (0 + byte0), 0.0F);
    this.part4 = new ModelRenderer(this, 24, 16);
    this.part4.addBox(-2.0F, 0.0F, -1.0F, 2, 2, 2);
    this.part4.setRotationPoint(3.0F, (3 + byte0), -3.0F);
    this.part5 = new ModelRenderer(this, 24, 16);
    this.part5.addBox(0.0F, 0.0F, -1.0F, 2, 2, 2);
    this.part5.setRotationPoint(-3.0F, (3 + byte0), -3.0F);
    this.part6 = new ModelRenderer(this, 16, 24);
    this.part6.addBox(-2.0F, 0.0F, -4.0F, 2, 2, 4);
    this.part6.setRotationPoint(3.0F, (3 + byte0), 4.0F);
    this.part7 = new ModelRenderer(this, 16, 24);
    this.part7.addBox(0.0F, 0.0F, -4.0F, 2, 2, 4);
    this.part7.setRotationPoint(-3.0F, (3 + byte0), 4.0F);
  }
