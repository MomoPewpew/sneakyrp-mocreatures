...
public class MoCModelFly
  ...
  public MoCModelFly() {
    ...
    this.Tail.addBox(-1.0F, 0.0F, -1.0F, 1, 1, 1);
    ...
    this.FrontLegs.setRotationPoint(0.0F, 22.5F, -1.8F);
    setRotation(this.FrontLegs, 0.1487144F, 0.0F, 0.0F);

    this.RearLegs = new ModelRenderer(this, 0, 11);
    this.RearLegs.addBox(-1.0F, 0.0F, 0.0F, 2, 2, 0);
    ...
    this.FoldedWings.setRotationPoint(0.0F, 20.5F, -2.0F);
