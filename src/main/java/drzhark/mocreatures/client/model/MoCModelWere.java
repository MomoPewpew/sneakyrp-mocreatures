  ...
  extends ModelBase
{
  ...
  public MoCModelWere() {
    ...
    this.LEar.addBox(0.5F, -7.5F, -1.0F, 3, 5, 1);
    this.LEar.setRotationPoint(0.0F, -8.0F, -6.0F);
    setRotation(this.LEar, 0.0F, 0.0F, 0.1745329F);

    this.REar = new ModelRenderer(this, 22, 0);
    this.REar.addBox(-3.5F, -7.5F, -1.0F, 3, 5, 1);
    this.REar.setRotationPoint(0.0F, -8.0F, -6.0F);
    setRotation(this.REar, 0.0F, 0.0F, -0.1745329F);

    this.Neck = new ModelRenderer(this, 28, 0);
    this.Neck.addBox(-3.5F, -3.0F, -7.0F, 7, 8, 7);
    this.Neck.setRotationPoint(0.0F, -5.0F, -2.0F);
    ...
    this.SideburnL.addBox(3.0F, 0.0F, -2.0F, 2, 6, 6);
    this.SideburnL.setRotationPoint(0.0F, -8.0F, -6.0F);
    setRotation(this.SideburnL, -0.2094395F, 0.418879F, -0.0872665F);

    this.SideburnR = new ModelRenderer(this, 28, 45);
    this.SideburnR.addBox(-5.0F, 0.0F, -2.0F, 2, 6, 6);
    this.SideburnR.setRotationPoint(0.0F, -8.0F, -6.0F);
    setRotation(this.SideburnR, -0.2094395F, -0.418879F, 0.0872665F);

    this.Chest = new ModelRenderer(this, 20, 15);
    this.Chest.addBox(-4.0F, 0.0F, -7.0F, 8, 8, 10);
    ...
    this.Abdomen.addBox(-3.0F, -8.0F, -8.0F, 6, 14, 8);
    ...
    this.TailA.addBox(-1.5F, -1.0F, -2.0F, 3, 4, 3);
    ...
    this.TailC.addBox(-2.0F, 6.8F, -4.6F, 4, 6, 4);
    ...
    this.TailB.addBox(-2.0F, 2.0F, -2.0F, 4, 6, 4);
    ...
    this.RLegA.setRotationPoint(-3.0F, 9.5F, 3.0F);
    setRotation(this.RLegA, -0.8126625F, 0.0F, 0.0F);

    this.RFoot = new ModelRenderer(this, 14, 93);
    this.RFoot.addBox(-2.506667F, 12.5F, -5.0F, 3, 2, 3);
    this.RFoot.setRotationPoint(-3.0F, 9.5F, 3.0F);

    this.RLegB = new ModelRenderer(this, 14, 76);
    this.RLegB.addBox(-1.9F, 4.2F, 0.5F, 2, 2, 5);
    this.RLegB.setRotationPoint(-3.0F, 9.5F, 3.0F);
    setRotation(this.RLegB, -0.8445741F, 0.0F, 0.0F);

    this.RLegC = new ModelRenderer(this, 14, 83);
    this.RLegC.addBox(-2.0F, 6.2F, 0.5F, 2, 8, 2);
    this.RLegC.setRotationPoint(-3.0F, 9.5F, 3.0F);
    setRotation(this.RLegC, -0.2860688F, 0.0F, 0.0F);

    this.LLegB = new ModelRenderer(this, 0, 76);
    this.LLegB.addBox(-0.1F, 4.2F, 0.5F, 2, 2, 5);
    this.LLegB.setRotationPoint(3.0F, 9.5F, 3.0F);
    setRotation(this.LLegB, -0.8445741F, 0.0F, 0.0F);

    this.LFoot = new ModelRenderer(this, 0, 93);
    this.LFoot.addBox(-0.5066667F, 12.5F, -5.0F, 3, 2, 3);
    this.LFoot.setRotationPoint(3.0F, 9.5F, 3.0F);

    this.LLegC = new ModelRenderer(this, 0, 83);
    this.LLegC.addBox(0.0F, 6.2F, 0.5F, 2, 8, 2);
    this.LLegC.setRotationPoint(3.0F, 9.5F, 3.0F);
    setRotation(this.LLegC, -0.2860688F, 0.0F, 0.0F);

    this.LLegA = new ModelRenderer(this, 0, 64);
    this.LLegA.addBox(-0.5F, -1.5F, -3.5F, 3, 8, 5);
    this.LLegA.setRotationPoint(3.0F, 9.5F, 3.0F);
    setRotation(this.LLegA, -0.8126625F, 0.0F, 0.0F);

    this.RArmB = new ModelRenderer(this, 48, 77);
    this.RArmB.addBox(-3.5F, 1.0F, -1.5F, 4, 8, 4);
    this.RArmB.setRotationPoint(-4.0F, -4.0F, -2.0F);
    setRotation(this.RArmB, 0.2617994F, 0.0F, 0.3490659F);

    this.RArmC = new ModelRenderer(this, 48, 112);
    this.RArmC.addBox(-6.0F, 5.0F, 3.0F, 4, 7, 4);
    this.RArmC.setRotationPoint(-4.0F, -4.0F, -2.0F);
    setRotation(this.RArmC, -0.3490659F, 0.0F, 0.0F);

    this.LArmB = new ModelRenderer(this, 48, 89);
    this.LArmB.addBox(-0.5F, 1.0F, -1.5F, 4, 8, 4);
    this.LArmB.setRotationPoint(4.0F, -4.0F, -2.0F);
    setRotation(this.LArmB, 0.2617994F, 0.0F, -0.3490659F);

    this.RHand = new ModelRenderer(this, 32, 118);
    this.RHand.addBox(-6.0F, 12.5F, -1.5F, 4, 3, 4);
    this.RHand.setRotationPoint(-4.0F, -4.0F, -2.0F);

    this.RArmA = new ModelRenderer(this, 0, 108);
    this.RArmA.addBox(-5.0F, -3.0F, -2.0F, 5, 5, 5);
    this.RArmA.setRotationPoint(-4.0F, -4.0F, -2.0F);
    setRotation(this.RArmA, 0.6320364F, 0.0F, 0.0F);

    this.LArmA = new ModelRenderer(this, 0, 98);
    this.LArmA.addBox(0.0F, -3.0F, -2.0F, 5, 5, 5);
    this.LArmA.setRotationPoint(4.0F, -4.0F, -2.0F);
    setRotation(this.LArmA, 0.6320364F, 0.0F, 0.0F);

    this.LArmC = new ModelRenderer(this, 48, 101);
    this.LArmC.addBox(2.0F, 5.0F, 3.0F, 4, 7, 4);
    this.LArmC.setRotationPoint(4.0F, -4.0F, -2.0F);
    setRotation(this.LArmC, -0.3490659F, 0.0F, 0.0F);

    this.LHand = new ModelRenderer(this, 32, 111);
    this.LHand.addBox(2.0F, 12.5F, -1.5F, 4, 3, 4);
    this.LHand.setRotationPoint(4.0F, -4.0F, -2.0F);

    this.RFinger1 = new ModelRenderer(this, 8, 120);
    this.RFinger1.addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1);
    this.RFinger1.setRotationPoint(-6.5F, 11.5F, -0.5F);

    this.RFinger1 = new ModelRenderer(this, 8, 120);
    this.RFinger1.addBox(-3.0F, 15.5F, 1.0F, 1, 3, 1);
    this.RFinger1.setRotationPoint(-4.0F, -4.0F, -2.0F);

    this.RFinger2 = new ModelRenderer(this, 12, 124);
    this.RFinger2.addBox(-3.5F, 15.5F, -1.5F, 1, 3, 1);
    this.RFinger2.setRotationPoint(-4.0F, -4.0F, -2.0F);

    this.RFinger3 = new ModelRenderer(this, 12, 119);
    this.RFinger3.addBox(-4.8F, 15.5F, -1.5F, 1, 4, 1);
    this.RFinger3.setRotationPoint(-4.0F, -4.0F, -2.0F);

    this.RFinger4 = new ModelRenderer(this, 16, 119);
    this.RFinger4.addBox(-6.0F, 15.5F, -0.5F, 1, 4, 1);
    this.RFinger4.setRotationPoint(-4.0F, -4.0F, -2.0F);

    this.RFinger5 = new ModelRenderer(this, 16, 124);
    this.RFinger5.addBox(-6.0F, 15.5F, 1.0F, 1, 3, 1);
    this.RFinger5.setRotationPoint(-4.0F, -4.0F, -2.0F);

    this.LFinger1 = new ModelRenderer(this, 8, 124);
    this.LFinger1.addBox(2.0F, 15.5F, 1.0F, 1, 3, 1);
    this.LFinger1.setRotationPoint(4.0F, -4.0F, -2.0F);

    this.LFinger2 = new ModelRenderer(this, 0, 124);
    this.LFinger2.addBox(2.5F, 15.5F, -1.5F, 1, 3, 1);
    this.LFinger2.setRotationPoint(4.0F, -4.0F, -2.0F);

    this.LFinger3 = new ModelRenderer(this, 0, 119);
    this.LFinger3.addBox(3.8F, 15.5F, -1.5F, 1, 4, 1);
    this.LFinger3.setRotationPoint(4.0F, -4.0F, -2.0F);

    this.LFinger4 = new ModelRenderer(this, 4, 119);
    this.LFinger4.addBox(5.0F, 15.5F, -0.5F, 1, 4, 1);
    this.LFinger4.setRotationPoint(4.0F, -4.0F, -2.0F);

    this.LFinger5 = new ModelRenderer(this, 4, 124);
    this.LFinger5.addBox(5.0F, 15.5F, 1.0F, 1, 3, 1);
    this.LFinger5.setRotationPoint(4.0F, -4.0F, -2.0F);
  }
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    this.Head.rotateAngleY = f3 / radianF;
    ...
    if (!this.hunched) {
      ...
      this.Neck.rotateAngleX = -34.0F / radianF;
      this.Neck.rotationPointY = -5.0F;
      this.Neck.rotationPointZ = -2.0F;
      this.Neck2.rotationPointY = -1.0F;
      this.Neck2.rotationPointZ = -6.0F;
      ...
      this.LLegA.rotationPointZ = 3.0F;

      this.LArmA.rotationPointY = -4.0F;
      this.LArmA.rotationPointZ = -2.0F;
      ...
      this.Head.rotateAngleX = (15.0F + f4) / radianF;

      this.Neck.rotateAngleX = -10.0F / radianF;
      this.Neck.rotationPointY = 2.0F;
      this.Neck.rotationPointZ = -6.0F;
      this.Neck2.rotationPointY = 9.0F;
      this.Neck2.rotationPointZ = -9.0F;
      ...
      this.LLegA.rotationPointZ = 7.0F;
      this.LArmA.rotationPointY = 4.5F;
      this.LArmA.rotationPointZ = -6.0F;
    ...
    this.Head.rotateAngleX += 2.530727F;
    this.Head.rotateAngleX += 2.530727F;
    ...
    this.RArmA.rotateAngleX = LLegXRot;
    this.LArmA.rotateAngleX = RLegXRot;
