...
public class MoCModelAnt
  ...
  public MoCModelAnt() {
    ...
    this.Mouth.addBox(0.0F, 0.0F, 0.0F, 2, 1, 0);
    this.Mouth.setRotationPoint(-1.0F, 22.3F, -1.9F);
    setRotation(this.Mouth, -0.8286699F, 0.0F, 0.0F);
    ...
    this.Thorax.setRotationPoint(0.0F, 20.0F, -0.5F);

    this.Abdomen = new ModelRenderer(this, 8, 1);
    this.Abdomen.addBox(-0.5F, -0.2F, -1.0F, 1, 2, 1);
    this.Abdomen.setRotationPoint(0.0F, 21.5F, 0.3F);
    setRotation(this.Abdomen, 1.706911F, 0.0F, 0.0F);

    this.MidLegs = new ModelRenderer(this, 4, 8);
    this.MidLegs.addBox(-1.0F, 0.0F, 0.0F, 2, 3, 0);
    this.MidLegs.setRotationPoint(0.0F, 22.0F, -0.7F);
    ...
    this.FrontLegs.setRotationPoint(0.0F, 22.0F, -0.8F);
    setRotation(this.FrontLegs, -0.6192304F, 0.0F, 0.0F);

    this.RearLegs = new ModelRenderer(this, 0, 8);
    this.RearLegs.addBox(-1.0F, 0.0F, 0.0F, 2, 3, 0);
    this.RearLegs.setRotationPoint(0.0F, 22.0F, 0.0F);
    setRotation(this.RearLegs, 0.9136644F, 0.0F, 0.0F);
  }
