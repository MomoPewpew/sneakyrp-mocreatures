  ...
  extends ModelBase
{
  ...
  public MoCModelOgre() {
    ...
    this.Brow.addBox(-5.0F, -10.5F, -8.0F, 10, 3, 2);
    this.Brow.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.Brow, -0.0872665F, 0.0F, 0.0F);

    this.NoseBridge = new ModelRenderer(this, 80, 4);
    this.NoseBridge.addBox(-1.0F, -7.0F, -8.0F, 2, 2, 1);
    this.NoseBridge.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.NoseBridge, -0.1745329F, 0.0F, 0.0F);

    this.Nose = new ModelRenderer(this, 80, 0);
    this.Nose.addBox(-2.0F, -7.0F, -7.0F, 4, 2, 2);
    this.Nose.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.Nose, 0.0872665F, 0.0F, 0.0F);

    this.RgtTusk = new ModelRenderer(this, 60, 4);
    this.RgtTusk.addBox(-3.5F, -6.0F, -6.5F, 1, 2, 1);
    this.RgtTusk.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.RgtTusk, 0.1745329F, 0.0F, 0.0F);

    this.RgtTooth = new ModelRenderer(this, 64, 4);
    this.RgtTooth.addBox(-1.5F, -5.0F, -6.5F, 1, 1, 1);
    this.RgtTooth.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.RgtTooth, 0.1745329F, 0.0F, 0.0F);

    this.LftTooth = new ModelRenderer(this, 72, 4);
    this.LftTooth.addBox(0.5F, -5.0F, -6.5F, 1, 1, 1);
    this.LftTooth.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.LftTooth, 0.1745329F, 0.0F, 0.0F);

    this.LftTusk = new ModelRenderer(this, 76, 4);
    this.LftTusk.addBox(2.5F, -6.0F, -6.5F, 1, 2, 1);
    this.LftTusk.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.LftTusk, 0.1745329F, 0.0F, 0.0F);

    this.Lip = new ModelRenderer(this, 60, 0);
    this.Lip.addBox(-4.0F, -4.0F, -7.0F, 8, 2, 2);
    this.Lip.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.Lip, 0.1745329F, 0.0F, 0.0F);

    this.RgtEar = new ModelRenderer(this, 60, 12);
    this.RgtEar.addBox(-9.0F, -9.0F, -1.0F, 3, 5, 2);
    this.RgtEar.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.RgtRing = new ModelRenderer(this, 32, 58);
    this.RgtRing.addBox(-8.0F, -6.0F, -2.0F, 1, 4, 4);
    this.RgtRing.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.RgtRingHole = new ModelRenderer(this, 26, 50);
    this.RgtRingHole.addBox(-8.0F, -5.0F, -1.0F, 1, 2, 2);
    this.RgtRingHole.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.LftEar = new ModelRenderer(this, 70, 12);
    this.LftEar.addBox(6.0F, -9.0F, -1.0F, 3, 5, 2);
    this.LftEar.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.LftRing = new ModelRenderer(this, 32, 58);
    this.LftRing.addBox(7.0F, -6.0F, -2.0F, 1, 4, 4);
    this.LftRing.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.LftRingHole = new ModelRenderer(this, 26, 50);
    this.LftRingHole.addBox(7.0F, -5.0F, -1.0F, 1, 2, 2);
    this.LftRingHole.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.HairRope = new ModelRenderer(this, 82, 83);
    this.HairRope.addBox(-2.0F, -8.0F, 9.0F, 4, 4, 4);
    this.HairRope.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.HairRope, 0.6108652F, 0.0F, 0.0F);

    this.Hair1 = new ModelRenderer(this, 78, 107);
    this.Hair1.addBox(-3.0F, -9.0F, 13.0F, 6, 8, 3);
    this.Hair1.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.Hair1, 0.6108652F, 0.0F, 0.0F);

    this.Hair2 = new ModelRenderer(this, 60, 107);
    this.Hair2.addBox(-3.0F, -6.5F, 11.6F, 6, 8, 3);
    this.Hair2.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.Hair2, 0.2617994F, 0.0F, 0.0F);

    this.Hair3 = new ModelRenderer(this, 42, 107);
    this.Hair3.addBox(-3.0F, -2.4F, 11.4F, 6, 8, 3);
    this.Hair3.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.DiamondHorn = new ModelRenderer(this, 120, 31);
    this.DiamondHorn.addBox(-1.0F, -17.0F, -6.0F, 2, 6, 2);
    this.DiamondHorn.setRotationPoint(0.0F, -13.0F, 0.0F);
    setRotation(this.DiamondHorn, 0.0872665F, 0.0F, 0.0F);

    this.RgtHorn = new ModelRenderer(this, 46, 6);
    this.RgtHorn.addBox(-6.0F, -12.0F, -11.0F, 2, 2, 5);
    this.RgtHorn.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.RgtHornTip = new ModelRenderer(this, 44, 13);
    this.RgtHornTip.addBox(-6.0F, -15.0F, -11.0F, 2, 3, 2);
    this.RgtHornTip.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.LftHorn = new ModelRenderer(this, 46, 6);
    this.LftHorn.addBox(4.0F, -12.0F, -11.0F, 2, 2, 5);
    this.LftHorn.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.LftHornTip = new ModelRenderer(this, 52, 13);
    this.LftHornTip.addBox(4.0F, -15.0F, -11.0F, 2, 3, 2);
    this.LftHornTip.setRotationPoint(0.0F, -13.0F, 0.0F);

    this.NeckRest = new ModelRenderer(this, 39, 20);
    this.NeckRest.addBox(-7.0F, -19.0F, -3.0F, 14, 3, 11);
    this.NeckRest.setRotationPoint(0.0F, 5.0F, 0.0F);
    ...
    this.Stomach.addBox(-11.0F, -8.0F, -6.0F, 22, 11, 14);
    this.Stomach.setRotationPoint(0.0F, 5.0F, 0.0F);

    this.ButtCover = new ModelRenderer(this, 32, 118);
    this.ButtCover.addBox(-4.0F, 0.0F, 0.0F, 8, 8, 2);
    this.ButtCover.setRotationPoint(0.0F, 8.0F, 6.0F);

    this.LoinCloth = new ModelRenderer(this, 32, 118);
    this.LoinCloth.addBox(-4.0F, 0.0F, -2.0F, 8, 8, 2);
    this.LoinCloth.setRotationPoint(0.0F, 8.0F, -4.0F);

    this.RgtThigh = new ModelRenderer(this, 0, 83);
    this.RgtThigh.addBox(-10.0F, 0.0F, -5.0F, 10, 11, 10);
    this.RgtThigh.setRotationPoint(-2.0F, 4.0F, 1.0F);

    this.RgtLeg = new ModelRenderer(this, 0, 104);
    this.RgtLeg.addBox(-4.0F, -1.0F, -4.0F, 8, 11, 8);
    this.RgtLeg.setRotationPoint(-5.0F, 10.0F, 0.0F);
    this.RgtThigh.addChild(this.RgtLeg);

    this.RgtKnee = new ModelRenderer(this, 0, 88);
    this.RgtKnee.addBox(-2.0F, -2.0F, -0.5F, 4, 4, 1);
    this.RgtKnee.setRotationPoint(0.0F, 2.0F, -4.25F);
    this.RgtLeg.addChild(this.RgtKnee);

    this.RgtToes = new ModelRenderer(this, 0, 123);
    this.RgtToes.addBox(-2.5F, -1.0F, -3.0F, 5, 2, 3);
    this.RgtToes.setRotationPoint(-1.5F, 9.0F, -3.5F);
    this.RgtLeg.addChild(this.RgtToes);

    this.RgtBigToe = new ModelRenderer(this, 20, 123);
    this.RgtBigToe.addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3);
    this.RgtBigToe.setRotationPoint(2.5F, 9.0F, -4.0F);
    this.RgtLeg.addChild(this.RgtBigToe);

    this.LftThigh = new ModelRenderer(this, 88, 83);
    this.LftThigh.addBox(0.0F, 0.0F, -5.0F, 10, 11, 10);
    this.LftThigh.setRotationPoint(2.0F, 4.0F, 1.0F);

    this.LftLeg = new ModelRenderer(this, 96, 104);
    this.LftLeg.addBox(-4.0F, -1.0F, -4.0F, 8, 11, 8);
    this.LftLeg.setRotationPoint(5.0F, 10.0F, 0.0F);
    this.LftThigh.addChild(this.LftLeg);

    this.LftKnee = new ModelRenderer(this, 118, 88);
    this.LftKnee.addBox(-2.0F, -2.0F, -0.5F, 4, 4, 1);
    this.LftKnee.setRotationPoint(0.0F, 2.0F, -4.25F);
    this.LftLeg.addChild(this.LftKnee);

    this.LftToes = new ModelRenderer(this, 112, 123);
    this.LftToes.addBox(-2.5F, -1.0F, -3.0F, 5, 2, 3);
    this.LftToes.setRotationPoint(1.5F, 9.0F, -3.5F);
    this.LftLeg.addChild(this.LftToes);

    this.LftBigToe = new ModelRenderer(this, 96, 123);
    this.LftBigToe.addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3);
    this.LftBigToe.setRotationPoint(-2.5F, 9.0F, -4.0F);
    this.LftLeg.addChild(this.LftBigToe);


    this.LftShoulder = new ModelRenderer(this, 96, 31);
    this.LftShoulder.addBox(0.0F, -3.0F, -4.0F, 8, 7, 8);
    this.LftShoulder.setRotationPoint(7.0F, -10.0F, 2.0F);

    this.LftArm = new ModelRenderer(this, 100, 66);
    this.LftArm.addBox(0.0F, 0.0F, -4.0F, 6, 9, 8);
    this.LftArm.setRotationPoint(6.0F, -1.0F, 1.0F);
    this.LftShoulder.addChild(this.LftArm);

    this.LftHand = new ModelRenderer(this, 96, 46);
    this.LftHand.addBox(-4.0F, 0.0F, -4.0F, 8, 12, 8);
    this.LftHand.setRotationPoint(3.0F, 8.0F, -1.0F);
    this.LftArm.addChild(this.LftHand);

    this.LftElbow = new ModelRenderer(this, 86, 64);
    this.LftElbow.addBox(-2.0F, -1.5F, -0.5F, 4, 3, 1);
    this.LftElbow.setRotationPoint(0.0F, 2.5F, 4.0F);
    this.LftHand.addChild(this.LftElbow);

    this.LftWeaponRoot = new ModelRenderer(this, 24, 104);
    this.LftWeaponRoot.addBox(-1.5F, -1.5F, -4.0F, 3, 3, 4);
    this.LftWeaponRoot.setRotationPoint(-0.5F, 8.5F, -4.0F);
    this.LftHand.addChild(this.LftWeaponRoot);

    this.LftWeaponEnd = new ModelRenderer(this, 74, 90);
    this.LftWeaponEnd.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 2);
    this.LftWeaponEnd.setRotationPoint(0.0F, 0.0F, 8.0F);
    this.LftWeaponRoot.addChild(this.LftWeaponEnd);

    this.LftWeaponLump = new ModelRenderer(this, 30, 83);
    this.LftWeaponLump.addBox(-2.5F, -2.5F, -4.0F, 5, 5, 4);
    this.LftWeaponLump.setRotationPoint(0.0F, 0.0F, -4.0F);
    this.LftWeaponRoot.addChild(this.LftWeaponLump);

    this.LftWeaponBetween = new ModelRenderer(this, 83, 42);
    this.LftWeaponBetween.addBox(-1.5F, -1.5F, -2.0F, 3, 3, 2);
    this.LftWeaponBetween.setRotationPoint(0.0F, 0.0F, -4.0F);
    this.LftWeaponLump.addChild(this.LftWeaponBetween);

    this.LftWeaponTip = new ModelRenderer(this, 60, 118);
    this.LftWeaponTip.addBox(-2.5F, -2.5F, -5.0F, 5, 5, 5);
    this.LftWeaponTip.setRotationPoint(0.0F, 0.0F, -2.0F);
    this.LftWeaponBetween.addChild(this.LftWeaponTip);

    this.LftHammerNeck = new ModelRenderer(this, 32, 39);
    this.LftHammerNeck.addBox(-0.5F, -4.0F, -4.0F, 1, 4, 4);
    this.LftHammerNeck.setRotationPoint(0.0F, -2.5F, -1.0F);
    this.LftWeaponTip.addChild(this.LftHammerNeck);

    this.LftHammerHeadSupport = new ModelRenderer(this, 0, 0);
    this.LftHammerHeadSupport.addBox(-1.0F, 0.0F, -2.0F, 2, 2, 4);
    this.LftHammerHeadSupport.setRotationPoint(0.0F, 2.5F, -3.0F);
    this.LftWeaponTip.addChild(this.LftHammerHeadSupport);

    this.LftHammerHead = new ModelRenderer(this, 32, 3);
    this.LftHammerHead.addBox(-2.0F, 0.0F, -2.5F, 4, 3, 5);
    this.LftHammerHead.setRotationPoint(0.0F, 2.0F, 0.0F);
    this.LftHammerHeadSupport.addChild(this.LftHammerHead);

    this.LftSpike = new ModelRenderer(this, 52, 118);
    this.LftSpike.addBox(-1.0F, -1.0F, -3.0F, 2, 2, 3);
    this.LftSpike.setRotationPoint(0.0F, 0.0F, -5.0F);
    this.LftWeaponTip.addChild(this.LftSpike);

    this.LftSpike1 = new ModelRenderer(this, 52, 118);
    this.LftSpike1.addBox(-3.0F, -1.0F, -1.0F, 3, 2, 2);
    this.LftSpike1.setRotationPoint(-2.5F, 0.0F, -3.0F);
    this.LftWeaponTip.addChild(this.LftSpike1);

    this.LftSpike2 = new ModelRenderer(this, 52, 118);
    this.LftSpike2.addBox(3.0F, -1.0F, -1.0F, 3, 2, 2);
    this.LftSpike2.setRotationPoint(-0.5F, 0.0F, -3.0F);
    this.LftWeaponTip.addChild(this.LftSpike2);

    this.LftSpike3 = new ModelRenderer(this, 52, 118);
    this.LftSpike3.addBox(-1.0F, 0.0F, -1.0F, 2, 3, 2);
    this.LftSpike3.setRotationPoint(0.0F, 2.5F, -3.0F);
    this.LftWeaponTip.addChild(this.LftSpike3);

    this.LftSpike4 = new ModelRenderer(this, 52, 118);
    this.LftSpike4.addBox(-1.0F, -3.0F, -1.0F, 2, 3, 2);
    this.LftSpike4.setRotationPoint(0.0F, -2.5F, -3.0F);
    this.LftWeaponTip.addChild(this.LftSpike4);


    this.RgtShoulder = new ModelRenderer(this, 0, 31);
    this.RgtShoulder.addBox(0.0F, -3.0F, -4.0F, 8, 7, 8);
    this.RgtShoulder.setRotationPoint(-15.0F, -10.0F, 2.0F);

    this.RgtArm = new ModelRenderer(this, 0, 66);
    this.RgtArm.addBox(0.0F, 0.0F, -4.0F, 6, 9, 8);
    this.RgtArm.setRotationPoint(-4.0F, -1.0F, 1.0F);
    this.RgtShoulder.addChild(this.RgtArm);

    this.RgtHand = new ModelRenderer(this, 0, 46);
    this.RgtHand.addBox(-4.0F, 0.0F, -4.0F, 8, 12, 8);
    this.RgtHand.setRotationPoint(3.0F, 8.0F, -1.0F);
    this.RgtArm.addChild(this.RgtHand);

    this.RgtElbow = new ModelRenderer(this, 86, 64);
    this.RgtElbow.addBox(-2.0F, -1.5F, -0.5F, 4, 3, 1);
    this.RgtElbow.setRotationPoint(0.0F, 2.5F, 4.0F);
    this.RgtHand.addChild(this.RgtElbow);

    this.RgtWeaponRoot = new ModelRenderer(this, 24, 104);
    this.RgtWeaponRoot.addBox(-1.5F, -1.5F, -4.0F, 3, 3, 4);
    this.RgtWeaponRoot.setRotationPoint(-0.5F, 8.5F, -4.0F);
    this.RgtHand.addChild(this.RgtWeaponRoot);

    this.RgtWeaponEnd = new ModelRenderer(this, 74, 90);
    this.RgtWeaponEnd.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 2);
    this.RgtWeaponEnd.setRotationPoint(0.0F, 0.0F, 8.0F);
    this.RgtWeaponRoot.addChild(this.RgtWeaponEnd);

    this.RgtWeaponLump = new ModelRenderer(this, 30, 83);
    this.RgtWeaponLump.addBox(-2.5F, -2.5F, -4.0F, 5, 5, 4);
    this.RgtWeaponLump.setRotationPoint(0.0F, 0.0F, -4.0F);
    this.RgtWeaponRoot.addChild(this.RgtWeaponLump);

    this.RgtWeaponBetween = new ModelRenderer(this, 83, 42);
    this.RgtWeaponBetween.addBox(-1.5F, -1.5F, -2.0F, 3, 3, 2);
    this.RgtWeaponBetween.setRotationPoint(0.0F, 0.0F, -4.0F);
    this.RgtWeaponLump.addChild(this.RgtWeaponBetween);

    this.RgtWeaponTip = new ModelRenderer(this, 60, 118);
    this.RgtWeaponTip.addBox(-2.5F, -2.5F, -5.0F, 5, 5, 5);
    this.RgtWeaponTip.setRotationPoint(0.0F, 0.0F, -2.0F);
    this.RgtWeaponBetween.addChild(this.RgtWeaponTip);

    this.RgtHammerNeck = new ModelRenderer(this, 32, 39);
    this.RgtHammerNeck.addBox(-0.5F, -4.0F, -4.0F, 1, 4, 4);
    this.RgtHammerNeck.setRotationPoint(0.0F, -2.5F, -1.0F);
    this.RgtWeaponTip.addChild(this.RgtHammerNeck);

    this.RgtHammerHeadSupport = new ModelRenderer(this, 0, 0);
    this.RgtHammerHeadSupport.addBox(-1.0F, 0.0F, -2.0F, 2, 2, 4);
    this.RgtHammerHeadSupport.setRotationPoint(0.0F, 2.5F, -3.0F);
    this.RgtWeaponTip.addChild(this.RgtHammerHeadSupport);

    this.RgtHammerHead = new ModelRenderer(this, 32, 3);
    this.RgtHammerHead.addBox(-2.0F, 0.0F, -2.5F, 4, 3, 5);
    this.RgtHammerHead.setRotationPoint(0.0F, 2.0F, 0.0F);
    this.RgtHammerHeadSupport.addChild(this.RgtHammerHead);

    this.RgtSpike = new ModelRenderer(this, 52, 118);
    this.RgtSpike.addBox(-1.0F, -1.0F, -3.0F, 2, 2, 3);
    this.RgtSpike.setRotationPoint(0.0F, 0.0F, -5.0F);
    this.RgtWeaponTip.addChild(this.RgtSpike);

    this.RgtSpike1 = new ModelRenderer(this, 52, 118);
    this.RgtSpike1.addBox(-3.0F, -1.0F, -1.0F, 3, 2, 2);
    this.RgtSpike1.setRotationPoint(-2.5F, 0.0F, -3.0F);
    this.RgtWeaponTip.addChild(this.RgtSpike1);

    this.RgtSpike2 = new ModelRenderer(this, 52, 118);
    this.RgtSpike2.addBox(3.0F, -1.0F, -1.0F, 3, 2, 2);
    this.RgtSpike2.setRotationPoint(-0.5F, 0.0F, -3.0F);
    this.RgtWeaponTip.addChild(this.RgtSpike2);

    this.RgtSpike3 = new ModelRenderer(this, 52, 118);
    this.RgtSpike3.addBox(-1.0F, 0.0F, -1.0F, 2, 3, 2);
    this.RgtSpike3.setRotationPoint(0.0F, 2.5F, -3.0F);
    this.RgtWeaponTip.addChild(this.RgtSpike3);

    this.RgtSpike4 = new ModelRenderer(this, 52, 118);
    this.RgtSpike4.addBox(-1.0F, -3.0F, -1.0F, 2, 3, 2);
    this.RgtSpike4.setRotationPoint(0.0F, -2.5F, -3.0F);
    this.RgtWeaponTip.addChild(this.RgtSpike4);

    this.Head3RgtEar = new ModelRenderer(this, 110, 24);
    this.Head3RgtEar.addBox(-8.0F, -9.0F, -1.0F, 3, 5, 2);
    this.Head3RgtEar.setRotationPoint(7.0F, -13.0F, 0.0F);

    this.Head3LftEar = new ModelRenderer(this, 100, 24);
    this.Head3LftEar.addBox(5.0F, -9.0F, -1.0F, 3, 5, 2);
    this.Head3LftEar.setRotationPoint(7.0F, -13.0F, 0.0F);

    this.Head3Eyelid = new ModelRenderer(this, 46, 3);
    this.Head3Eyelid.addBox(-3.0F, -8.0F, -4.5F, 6, 2, 1);
    this.Head3Eyelid.setRotationPoint(7.0F, -13.0F, 0.0F);
    ...
    this.Head3Nose.setRotationPoint(7.0F, -13.0F, 0.0F);
    setRotation(this.Head3Nose, 0.4886922F, 0.0F, 0.0F);

    this.Head3 = new ModelRenderer(this, 42, 83);
    this.Head3.addBox(-5.0F, -12.0F, -6.0F, 10, 12, 12);
    this.Head3.setRotationPoint(7.0F, -13.0F, 0.0F);

    this.Head3Brow = new ModelRenderer(this, 46, 0);
    this.Head3Brow.addBox(-3.0F, -9.0F, -8.5F, 6, 2, 1);
    this.Head3Brow.setRotationPoint(7.0F, -13.0F, 0.0F);
    setRotation(this.Head3Brow, -0.2617994F, 0.0F, 0.0F);

    this.Head3Hair = new ModelRenderer(this, 80, 118);
    this.Head3Hair.addBox(-2.0F, -17.0F, -5.0F, 4, 6, 4);
    this.Head3Hair.setRotationPoint(7.0F, -13.0F, 0.0F);
    setRotation(this.Head3Hair, -0.6108652F, 0.0F, 0.0F);

    this.Head3Lip = new ModelRenderer(this, 22, 68);
    this.Head3Lip.addBox(-4.0F, -4.0F, -7.0F, 8, 2, 2);
    this.Head3Lip.setRotationPoint(7.0F, -13.0F, 0.0F);
    setRotation(this.Head3Lip, 0.1745329F, 0.0F, 0.0F);

    this.Head3RgtTusk = new ModelRenderer(this, 83, 34);
    this.Head3RgtTusk.addBox(-3.5F, -6.0F, -6.5F, 1, 2, 1);
    this.Head3RgtTusk.setRotationPoint(7.0F, -13.0F, 0.0F);

    setRotation(this.Head3RgtTusk, 0.1745329F, 0.0F, 0.0F);
    this.Head3RgtTooth = new ModelRenderer(this, 87, 34);
    this.Head3RgtTooth.addBox(-1.5F, -5.0F, -6.5F, 1, 1, 1);
    this.Head3RgtTooth.setRotationPoint(7.0F, -13.0F, 0.0F);
    setRotation(this.Head3RgtTooth, 0.1745329F, 0.0F, 0.0F);

    this.Head3LftTooth = new ModelRenderer(this, 96, 34);
    this.Head3LftTooth.addBox(0.5F, -5.0F, -6.5F, 1, 1, 1);
    this.Head3LftTooth.setRotationPoint(7.0F, -13.0F, 0.0F);
    setRotation(this.Head3LftTooth, 0.1745329F, 0.0F, 0.0F);

    this.Head3LftTusk = new ModelRenderer(this, 100, 34);
    this.Head3LftTusk.addBox(2.5F, -6.0F, -6.5F, 1, 2, 1);
    this.Head3LftTusk.setRotationPoint(7.0F, -13.0F, 0.0F);
    setRotation(this.Head3LftTusk, 0.1745329F, 0.0F, 0.0F);

    this.Head3RingHole = new ModelRenderer(this, 26, 50);
    this.Head3RingHole.addBox(6.0F, -5.0F, -1.0F, 1, 2, 2);
    this.Head3RingHole.setRotationPoint(7.0F, -13.0F, 0.0F);

    this.Head3Ring = new ModelRenderer(this, 32, 58);
    this.Head3Ring.addBox(6.0F, -6.0F, -2.0F, 1, 4, 4);
    this.Head3Ring.setRotationPoint(7.0F, -13.0F, 0.0F);

    this.Head2Chin = new ModelRenderer(this, 21, 24);
    this.Head2Chin.addBox(-3.0F, -5.0F, -8.0F, 6, 3, 3);
    this.Head2Chin.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2Chin, 0.2617994F, 0.0F, 0.0F);

    this.Head2 = new ModelRenderer(this, 0, 0);
    this.Head2.addBox(-5.0F, -12.0F, -6.0F, 10, 12, 12);
    this.Head2.setRotationPoint(-7.0F, -13.0F, 0.0F);

    this.Head2Lip = new ModelRenderer(this, 0, 24);
    this.Head2Lip.addBox(-4.0F, -5.0F, -8.0F, 8, 2, 2);
    this.Head2Lip.setRotationPoint(-7.0F, -13.0F, 0.0F);

    this.Head2LftTusk = new ModelRenderer(this, 46, 28);
    this.Head2LftTusk.addBox(2.5F, -8.0F, -6.5F, 1, 2, 1);
    this.Head2LftTusk.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2LftTusk, 0.1745329F, 0.0F, 0.0F);

    this.Head2RgtTusk = new ModelRenderer(this, 39, 28);
    this.Head2RgtTusk.addBox(-3.5F, -8.0F, -6.5F, 1, 2, 1);
    this.Head2RgtTusk.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2RgtTusk, 0.1745329F, 0.0F, 0.0F);

    this.Head2Nose = new ModelRenderer(this, 116, 0);
    this.Head2Nose.addBox(-2.0F, -7.0F, -7.0F, 4, 2, 2);
    this.Head2Nose.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2Nose, 0.0872665F, 0.0F, 0.0F);

    this.Head2NoseBridge = new ModelRenderer(this, 116, 4);
    this.Head2NoseBridge.addBox(-1.0F, -7.0F, -8.0F, 2, 2, 1);
    this.Head2NoseBridge.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2NoseBridge, -0.1745329F, 0.0F, 0.0F);

    this.Head2Brow = new ModelRenderer(this, 80, 24);
    this.Head2Brow.addBox(-4.0F, -10.5F, -8.0F, 8, 3, 2);
    this.Head2Brow.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2Brow, -0.0872665F, 0.0F, 0.0F);

    this.Head2RgtHorn = new ModelRenderer(this, 24, 30);
    this.Head2RgtHorn.addBox(-4.0F, -8.0F, -15.0F, 2, 2, 5);
    this.Head2RgtHorn.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2RgtHorn, -0.5235988F, 0.0F, 0.0F);

    this.Head2LftHorn = new ModelRenderer(this, 24, 30);
    this.Head2LftHorn.addBox(2.0F, -8.0F, -15.0F, 2, 2, 5);
    this.Head2LftHorn.setRotationPoint(-7.0F, -13.0F, 0.0F);
    setRotation(this.Head2LftHorn, -0.5235988F, 0.0F, 0.0F);

    this.Head2DiamondHorn = new ModelRenderer(this, 120, 46);
    this.Head2DiamondHorn.addBox(-1.0F, -17.0F, -6.0F, 2, 6, 2);
    this.Head2DiamondHorn.setRotationPoint(-7.0F, -13.0F, 0.0F);
