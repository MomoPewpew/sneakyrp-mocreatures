...
public class MoCModelDragonfly
  ...
  public MoCModelDragonfly() {
    ...
    this.RAntenna.addBox(-0.5F, 0.0F, -1.0F, 1, 0, 1);
    this.RAntenna.setRotationPoint(-0.5F, 19.7F, -2.3F);
    setRotation(this.RAntenna, -1.041001F, 0.7853982F, 0.0F);

    this.LAntenna = new ModelRenderer(this, 4, 7);
    this.LAntenna.addBox(-0.5F, 0.0F, -1.0F, 1, 0, 1);
    this.LAntenna.setRotationPoint(0.5F, 19.7F, -2.3F);
    setRotation(this.LAntenna, -1.041001F, -0.7853982F, 0.0F);

    this.Mouth = new ModelRenderer(this, 0, 11);
    this.Mouth.addBox(-0.5F, 0.0F, 0.0F, 1, 1, 1);
    this.Mouth.setRotationPoint(0.0F, 21.1F, -2.3F);
    setRotation(this.Mouth, -2.171231F, 0.0F, 0.0F);
    ...
    this.Abdomen.addBox(-0.5F, 0.0F, -1.0F, 1, 7, 1);
    this.Abdomen.setRotationPoint(0.0F, 20.5F, 0.0F);
    ...
    this.RearLegs.setRotationPoint(0.0F, 22.0F, -0.4F);
    setRotation(this.RearLegs, 1.070744F, 0.0F, 0.0F);

    this.WingFrontRight = new ModelRenderer(this, 0, 28);
    this.WingFrontRight.addBox(-7.0F, 0.0F, -1.0F, 7, 0, 2);
    this.WingFrontRight.setRotationPoint(-1.0F, 20.0F, -1.0F);
    setRotation(this.WingFrontRight, 0.0F, -0.1396263F, 0.0872665F);

    this.WingFrontLeft = new ModelRenderer(this, 0, 30);
    this.WingFrontLeft.addBox(0.0F, 0.0F, -1.0F, 7, 0, 2);
    this.WingFrontLeft.setRotationPoint(1.0F, 20.0F, -1.0F);
    setRotation(this.WingFrontLeft, 0.0F, 0.1396263F, -0.0872665F);

    this.WingRearRight = new ModelRenderer(this, 0, 24);
    this.WingRearRight.addBox(-7.0F, 0.0F, -1.0F, 7, 0, 2);
    this.WingRearRight.setRotationPoint(-1.0F, 20.0F, -1.0F);
    setRotation(this.WingRearRight, 0.0F, 0.3490659F, -0.0872665F);

    this.WingRearLeft = new ModelRenderer(this, 0, 26);
    this.WingRearLeft.addBox(0.0F, 0.0F, -1.0F, 7, 0, 2);
    this.WingRearLeft.setRotationPoint(1.0F, 20.0F, -1.0F);
    setRotation(this.WingRearLeft, 0.0F, -0.3490659F, 0.0872665F);
  }
