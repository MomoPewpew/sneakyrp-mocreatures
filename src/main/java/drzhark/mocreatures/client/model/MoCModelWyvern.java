  ...
  extends ModelBase
{
  ...
  public MoCModelWyvern() {
    ...
    this.MainHead.setRotationPoint(0.0F, 3.0F, -15.0F);

    this.neck2 = new ModelRenderer(this, 102, 99);
    this.neck2.addBox(-2.5F, -3.0F, -8.0F, 5, 6, 8);
    ...
    this.neckplate2.addBox(-1.5F, -2.0F, -8.0F, 3, 2, 8);
    this.neckplate2.setRotationPoint(0.0F, -3.0F, 0.0F);
    this.neck2.addChild(this.neckplate2);

    this.neck1 = new ModelRenderer(this, 104, 85);
    this.neck1.addBox(-2.0F, -3.0F, -8.0F, 4, 6, 8);

    this.neck1.setRotationPoint(0.0F, -0.5F, -5.5F);

    this.neck2.addChild(this.neck1);

    this.neckplate1 = new ModelRenderer(this, 80, 108);
    this.neckplate1.addBox(-1.0F, -2.0F, -8.0F, 2, 2, 8);
    this.neckplate1.setRotationPoint(0.0F, -3.0F, 0.0F);
    ...
    this.snout.addBox(-2.0F, -1.5F, -9.0F, 4, 3, 9);
    this.snout.setRotationPoint(0.0F, -1.5F, -8.0F);
    setRotation(this.snout, 2.0F / this.radianF, 0.0F, 0.0F);
    this.head.addChild(this.snout);

    this.headplate = new ModelRenderer(this, 80, 118);
    this.headplate.addBox(-1.0F, -1.0F, -4.0F, 2, 2, 8);
    this.headplate.setRotationPoint(0.0F, -3.0F, -1.0F);
    ...
    this.beak.setRotationPoint(0.0F, 0.8F, -8.0F);
    ...
    this.righteyesock.addBox(0.0F, 0.0F, 0.0F, 1, 2, 4);
    this.righteyesock.setRotationPoint(-3.5F, -2.5F, -8.0F);
    this.head.addChild(this.righteyesock);

    this.lefteyesock = new ModelRenderer(this, 70, 114);
    this.lefteyesock.addBox(0.0F, 0.0F, 0.0F, 1, 2, 4);
    this.lefteyesock.setRotationPoint(2.5F, -2.5F, -8.0F);
    this.head.addChild(this.lefteyesock);

    this.Jaw = new ModelRenderer(this, 72, 82);
    this.Jaw.addBox(-2.0F, -1.0F, -9.0F, 4, 2, 9);
    this.Jaw.setRotationPoint(0.0F, 2.5F, -7.5F);
    setRotation(this.Jaw, -10.0F / this.radianF, 0.0F, 0.0F);
    this.head.addChild(this.Jaw);

    this.leftupjaw = new ModelRenderer(this, 42, 93);
    this.leftupjaw.addBox(-1.0F, -1.0F, -6.5F, 2, 2, 13);
    this.leftupjaw.setRotationPoint(2.0F, 0.0F, -10.5F);
    ...
    this.rightupjaw.addBox(-1.0F, -1.0F, -6.5F, 2, 2, 13);
    this.rightupjaw.setRotationPoint(-2.0F, 0.0F, -10.5F);
    ...
    this.mouthrod.addBox(-5.0F, -1.0F, -1.0F, 10, 2, 2);
    this.mouthrod.setRotationPoint(0.0F, 1.0F, -8.0F);
    this.head.addChild(this.mouthrod);

    this.helmetstrap1 = new ModelRenderer(this, 32, 146);
    this.helmetstrap1.addBox(-4.0F, -2.0F, 0.0F, 8, 4, 1);
    this.helmetstrap1.setRotationPoint(0.0F, 2.0F, -7.5F);
    this.head.addChild(this.helmetstrap1);

    this.helmetstrap2 = new ModelRenderer(this, 32, 141);
    this.helmetstrap2.addBox(-4.0F, -2.0F, 0.0F, 8, 4, 1);
    this.helmetstrap2.setRotationPoint(0.0F, 2.0F, -3.5F);
    this.head.addChild(this.helmetstrap2);

    this.controlrope1 = new ModelRenderer(this, 66, 43);
    this.controlrope1.addBox(0.0F, -2.0F, 0.0F, 0, 4, 23);
    this.controlrope1.setRotationPoint(4.5F, 1.0F, 0.0F);
    this.mouthrod.addChild(this.controlrope1);

    this.controlrope2 = new ModelRenderer(this, 66, 43);
    this.controlrope2.addBox(0.0F, -2.0F, 0.0F, 0, 4, 23);
    this.controlrope2.setRotationPoint(-4.5F, 1.0F, 0.0F);
    this.mouthrod.addChild(this.controlrope2);

    this.rightearskin = new ModelRenderer(this, 112, 201);
    this.rightearskin.addBox(0.0F, -4.0F, 0.0F, 0, 8, 8);
    this.rightearskin.setRotationPoint(-3.0F, -0.5F, 0.0F);
    this.head.addChild(this.rightearskin);

    this.leftearskin = new ModelRenderer(this, 96, 201);
    this.leftearskin.addBox(0.0F, -4.0F, 0.0F, 0, 8, 8);
    this.leftearskin.setRotationPoint(3.0F, -0.5F, 0.0F);
    this.head.addChild(this.leftearskin);

    this.rightspine1 = new ModelRenderer(this, 50, 141);
    this.rightspine1.addBox(-0.5F, -1.0F, 0.0F, 1, 2, 8);
    this.rightspine1.setRotationPoint(0.0F, -2.0F, 0.0F);
    ...
    this.rightspine2.addBox(-0.5F, -1.0F, 0.0F, 1, 2, 8);
    this.rightspine2.setRotationPoint(0.0F, 0.0F, 0.0F);

    this.rightearskin.addChild(this.rightspine2);

    this.rightspine3 = new ModelRenderer(this, 50, 141);
    this.rightspine3.addBox(-0.5F, -1.0F, 0.0F, 1, 2, 8);
    this.rightspine3.setRotationPoint(0.0F, 2.0F, 0.0F);
    ...
    this.leftspine1.addBox(-0.5F, -1.0F, 0.0F, 1, 2, 8);
    this.leftspine1.setRotationPoint(0.0F, -2.0F, 0.0F);
    ...
    this.leftspine2.addBox(-0.5F, -1.0F, 0.0F, 1, 2, 8);
    this.leftspine2.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.leftearskin.addChild(this.leftspine2);

    this.leftspine3 = new ModelRenderer(this, 68, 141);
    this.leftspine3.addBox(-0.5F, -1.0F, 0.0F, 1, 2, 8);
    this.leftspine3.setRotationPoint(0.0F, 2.0F, 0.0F);
    ...
    this.ironhelmethorn1.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 8);
    this.ironhelmethorn1.setRotationPoint(-0.5F, 0.0F, 0.1F);
    this.leftspine1.addChild(this.ironhelmethorn1);

    this.ironhelmethorn2 = new ModelRenderer(this, 106, 128);
    this.ironhelmethorn2.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 8);
    this.ironhelmethorn2.setRotationPoint(0.5F, 0.0F, 0.1F);
    this.rightspine1.addChild(this.ironhelmethorn2);

    this.ironhelmet = new ModelRenderer(this, 32, 128);
    this.ironhelmet.addBox(-4.0F, -4.0F, -9.0F, 8, 4, 9);
    this.ironhelmet.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.head.addChild(this.ironhelmet);

    this.ironhelmetsnout = new ModelRenderer(this, 0, 144);
    this.ironhelmetsnout.addBox(-2.5F, -2.0F, -7.0F, 5, 2, 7);
    this.ironhelmetsnout.setRotationPoint(0.0F, 0.0F, -1.0F);
    this.snout.addChild(this.ironhelmetsnout);

    this.goldhelmethorn1 = new ModelRenderer(this, 106, 161);
    this.goldhelmethorn1.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 8);
    this.goldhelmethorn1.setRotationPoint(-0.5F, 0.0F, 0.1F);
    this.leftspine1.addChild(this.goldhelmethorn1);

    this.goldhelmethorn2 = new ModelRenderer(this, 106, 150);
    this.goldhelmethorn2.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 8);
    this.goldhelmethorn2.setRotationPoint(0.5F, 0.0F, 0.1F);
    this.rightspine1.addChild(this.goldhelmethorn2);

    this.goldhelmet = new ModelRenderer(this, 94, 226);
    this.goldhelmet.addBox(-4.0F, -4.0F, -9.0F, 8, 4, 9);
    this.goldhelmet.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.head.addChild(this.goldhelmet);

    this.goldhelmetsnout = new ModelRenderer(this, 71, 235);
    this.goldhelmetsnout.addBox(-2.5F, -2.0F, -7.0F, 5, 2, 7);
    this.goldhelmetsnout.setRotationPoint(0.0F, 0.0F, -1.0F);
    this.snout.addChild(this.goldhelmetsnout);

    this.diamondhelmet = new ModelRenderer(this, 23, 226);
    this.diamondhelmet.addBox(-4.0F, -4.0F, -9.0F, 8, 4, 9);
    this.diamondhelmet.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.head.addChild(this.diamondhelmet);

    this.diamondhelmethorn2 = new ModelRenderer(this, 49, 234);
    this.diamondhelmethorn2.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 8);
    this.diamondhelmethorn2.setRotationPoint(0.5F, 0.0F, 0.1F);
    this.rightspine1.addChild(this.diamondhelmethorn2);

    this.diamondhelmethorn1 = new ModelRenderer(this, 49, 245);
    this.diamondhelmethorn1.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 8);
    this.diamondhelmethorn1.setRotationPoint(-0.5F, 0.0F, 0.1F);
    this.leftspine1.addChild(this.diamondhelmethorn1);

    this.diamondhelmetsnout = new ModelRenderer(this, 0, 235);
    this.diamondhelmetsnout.addBox(-2.5F, -2.0F, -7.0F, 5, 2, 7);
    this.diamondhelmetsnout.setRotationPoint(0.0F, 0.0F, -1.0F);
    this.snout.addChild(this.diamondhelmetsnout);

    this.torso = new ModelRenderer(this, 0, 0);
    this.torso.addBox(-5.0F, 0.0F, -12.0F, 10, 10, 12);
    this.torso.setRotationPoint(0.0F, 0.0F, 0.0F);

    this.saddle = new ModelRenderer(this, 38, 70);
    this.saddle.addBox(-3.5F, -2.5F, -8.0F, 7, 3, 10);
    this.saddle.setRotationPoint(0.0F, 0.0F, 0.0F);

    this.rightshoulder = new ModelRenderer(this, 42, 83);
    this.rightshoulder.addBox(-6.0F, 1.0F, -12.5F, 4, 5, 5);
    ...
    this.leftshoulder.addBox(2.0F, 1.0F, -12.5F, 4, 5, 5);
    this.leftshoulder.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.leftshoulder, -0.2617994F, 0.0F, 0.0F);


    this.LeftWing = new ModelRenderer(this);
    this.LeftWing.setRotationPoint(4.0F, 1.0F, -11.0F);

    this.leftuparm = new ModelRenderer(this, 44, 14);
    this.leftuparm.addBox(0.0F, -2.0F, -2.0F, 10, 4, 4);
    this.leftuparm.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.leftlowarm.addBox(0.0F, -2.0F, -2.0F, 10, 4, 4);
    this.leftlowarm.setRotationPoint(9.0F, 0.0F, 0.0F);
    ...
    this.leftfing1a.addBox(0.0F, 0.0F, -1.0F, 2, 15, 2);
    this.leftfing1a.setRotationPoint(9.0F, 1.0F, 0.0F);
    ...
    this.leftfing1b.addBox(0.0F, 0.0F, -1.0F, 2, 10, 2);
    this.leftfing1b.setRotationPoint(0.0F, 14.0F, 0.0F);
    ...
    this.leftfing2a.addBox(-1.0F, 0.0F, 0.0F, 2, 15, 2);
    this.leftfing2a.setRotationPoint(9.0F, 1.0F, 0.0F);
    ...
    this.leftfing2b.addBox(-1.0F, 0.0F, 0.0F, 2, 10, 2);
    this.leftfing2b.setRotationPoint(0.0F, 14.0F, 0.0F);
    ...
    this.leftfing3a.addBox(-1.0F, 0.0F, 1.0F, 2, 15, 2);
    this.leftfing3a.setRotationPoint(9.0F, 1.0F, 0.0F);
    ...
    this.leftfing3b.addBox(-1.0F, 0.0F, 1.0F, 2, 10, 2);
    this.leftfing3b.setRotationPoint(0.0F, 14.0F, 0.0F);
    ...
    this.leftwingflap1.addBox(3.5F, -3.0F, 0.95F, 14, 24, 0);
    this.leftwingflap1.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.leftwingflap2.addBox(-7.0F, 1.05F, 1.05F, 19, 24, 0);
    this.leftwingflap2.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.leftwingflap3.addBox(-17.5F, 1.0F, 1.1F, 18, 24, 0);
    this.leftwingflap3.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.leftfing3a.addChild(this.leftwingflap3);


    this.RightWing = new ModelRenderer(this);
    this.RightWing.setRotationPoint(-4.0F, 1.0F, -11.0F);

    this.rightuparm = new ModelRenderer(this, 44, 22);
    this.rightuparm.addBox(-10.0F, -2.0F, -2.0F, 10, 4, 4);
    this.rightuparm.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.rightlowarm.addBox(-10.0F, -2.0F, -2.0F, 10, 4, 4);
    this.rightlowarm.setRotationPoint(-9.0F, 0.0F, 0.0F);
    ...
    this.rightfing1a.addBox(-1.0F, 0.0F, -1.0F, 2, 15, 2);
    this.rightfing1a.setRotationPoint(-9.0F, 1.0F, -1.0F);
    ...
    this.rightfing1b.addBox(-1.0F, 0.0F, -1.0F, 2, 10, 2);
    this.rightfing1b.setRotationPoint(0.0F, 14.0F, 0.0F);
    ...
    this.rightwingflap1.addBox(-17.5F, -3.0F, 0.95F, 14, 24, 0);
    this.rightwingflap1.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.rightfing2a.addBox(-1.0F, 0.0F, 0.0F, 2, 15, 2);
    this.rightfing2a.setRotationPoint(-9.0F, 1.0F, 0.0F);
    ...
    this.rightfing2b.addBox(-1.0F, 0.0F, 0.0F, 2, 10, 2);
    this.rightfing2b.setRotationPoint(0.0F, 14.0F, 0.0F);
    ...
    this.rightwingflap2.addBox(-19.0F, 1.05F, 1.05F, 19, 24, 0);
    this.rightwingflap2.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.rightfing3a.addBox(-1.0F, 0.0F, 1.0F, 2, 15, 2);
    this.rightfing3a.setRotationPoint(-9.0F, 1.0F, 0.0F);
    ...
    this.rightfing3b.addBox(-1.0F, 0.0F, 1.0F, 2, 10, 2);
    this.rightfing3b.setRotationPoint(0.0F, 14.0F, 0.0F);
    ...
    this.rightwingflap3.addBox(-0.5F, 1.0F, 1.1F, 18, 24, 0);
    this.rightwingflap3.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.rightfing3a.addChild(this.rightwingflap3);


    this.leftupleg = new ModelRenderer(this, 0, 111);
    this.leftupleg.addBox(-2.0F, -3.0F, -3.0F, 4, 10, 7);
    this.leftupleg.setRotationPoint(5.0F, 6.0F, -5.0F);
    setRotation(this.leftupleg, -25.0F / this.radianF, 0.0F, 0.0F);

    this.leftmidleg = new ModelRenderer(this, 0, 102);
    this.leftmidleg.addBox(-1.5F, -2.0F, 0.0F, 3, 4, 5);
    this.leftmidleg.setRotationPoint(0.0F, 5.0F, 4.0F);
    this.leftupleg.addChild(this.leftmidleg);

    this.leftlowleg = new ModelRenderer(this, 0, 91);
    this.leftlowleg.addBox(-1.5F, 0.0F, -1.5F, 3, 8, 3);
    this.leftlowleg.setRotationPoint(0.0F, 2.0F, 3.5F);
    this.leftmidleg.addChild(this.leftlowleg);

    this.leftfoot = new ModelRenderer(this, 44, 121);
    this.leftfoot.addBox(-2.0F, -1.0F, -3.0F, 4, 3, 4);
    this.leftfoot.setRotationPoint(0.0F, 7.0F, 0.5F);
    ...
    this.lefttoe1.addBox(-0.5F, -1.0F, -3.0F, 1, 2, 3);
    this.lefttoe1.setRotationPoint(-1.5F, 1.0F, -3.0F);
    this.leftfoot.addChild(this.lefttoe1);

    this.lefttoe3 = new ModelRenderer(this, 96, 30);
    this.lefttoe3.addBox(-0.5F, -1.0F, -3.0F, 1, 2, 3);
    this.lefttoe3.setRotationPoint(1.5F, 1.0F, -3.0F);
    this.leftfoot.addChild(this.lefttoe3);

    this.lefttoe2 = new ModelRenderer(this, 84, 30);
    this.lefttoe2.addBox(-1.0F, -1.5F, -4.0F, 2, 3, 4);
    this.lefttoe2.setRotationPoint(0.0F, 0.5F, -3.0F);
    this.leftfoot.addChild(this.lefttoe2);

    this.leftclaw1 = new ModelRenderer(this, 100, 26);
    this.leftclaw1.addBox(-0.5F, 0.0F, -0.5F, 1, 2, 1);
    ...
    this.leftclaw2.addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1);
    this.leftclaw2.setRotationPoint(0.0F, -1.0F, -3.5F);
    ...
    this.leftclaw3.addBox(-0.5F, 0.0F, -0.5F, 1, 2, 1);
    ...
    this.ironleftlegarmor.addBox(-2.0F, -2.5F, -2.0F, 4, 5, 4);
    this.ironleftlegarmor.setRotationPoint(0.0F, 2.5F, 0.0F);
    this.leftlowleg.addChild(this.ironleftlegarmor);

    this.goldleftlegarmor = new ModelRenderer(this, 112, 181);
    this.goldleftlegarmor.addBox(-2.0F, -2.5F, -2.0F, 4, 5, 4);
    this.goldleftlegarmor.setRotationPoint(0.0F, 2.5F, 0.0F);
    this.leftlowleg.addChild(this.goldleftlegarmor);

    this.diamondleftlegarmor = new ModelRenderer(this, 43, 215);
    this.diamondleftlegarmor.addBox(-2.0F, -2.5F, -2.0F, 4, 5, 4);
    this.diamondleftlegarmor.setRotationPoint(0.0F, 2.5F, 0.0F);
    this.leftlowleg.addChild(this.diamondleftlegarmor);


    this.rightupleg = new ModelRenderer(this, 0, 111);
    this.rightupleg.addBox(-2.0F, -3.0F, -3.0F, 4, 10, 7);
    this.rightupleg.setRotationPoint(-5.0F, 6.0F, -5.0F);
    setRotation(this.rightupleg, -25.0F / this.radianF, 0.0F, 0.0F);

    this.rightmidleg = new ModelRenderer(this, 0, 102);
    this.rightmidleg.addBox(-1.5F, -2.0F, 0.0F, 3, 4, 5);
    this.rightmidleg.setRotationPoint(0.0F, 5.0F, 4.0F);
    this.rightupleg.addChild(this.rightmidleg);

    this.rightlowleg = new ModelRenderer(this, 0, 91);
    this.rightlowleg.addBox(-1.5F, 0.0F, -1.5F, 3, 8, 3);
    this.rightlowleg.setRotationPoint(0.0F, 2.0F, 3.5F);
    this.rightmidleg.addChild(this.rightlowleg);

    this.rightfoot = new ModelRenderer(this, 44, 121);
    this.rightfoot.addBox(-2.0F, -1.0F, -3.0F, 4, 3, 4);
    this.rightfoot.setRotationPoint(0.0F, 7.0F, 0.5F);
    ...
    this.righttoe1.addBox(-0.5F, -1.0F, -3.0F, 1, 2, 3);
    this.righttoe1.setRotationPoint(-1.5F, 1.0F, -3.0F);
    this.rightfoot.addChild(this.righttoe1);

    this.righttoe3 = new ModelRenderer(this, 96, 30);
    this.righttoe3.addBox(-0.5F, -1.0F, -3.0F, 1, 2, 3);
    this.righttoe3.setRotationPoint(1.5F, 1.0F, -3.0F);
    this.rightfoot.addChild(this.righttoe3);

    this.righttoe2 = new ModelRenderer(this, 84, 30);
    this.righttoe2.addBox(-1.0F, -1.5F, -4.0F, 2, 3, 4);
    this.righttoe2.setRotationPoint(0.0F, 0.5F, -3.0F);
    this.rightfoot.addChild(this.righttoe2);

    this.rightclaw1 = new ModelRenderer(this, 100, 26);
    this.rightclaw1.addBox(-0.5F, 0.0F, -0.5F, 1, 2, 1);
    ...
    this.rightclaw2.addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1);
    this.rightclaw2.setRotationPoint(0.0F, -1.0F, -3.5F);
    ...
    this.rightclaw3.addBox(-0.5F, 0.0F, -0.5F, 1, 2, 1);
    ...
    this.ironrightlegarmor.addBox(-2.0F, -2.5F, -2.0F, 4, 5, 4);
    this.ironrightlegarmor.setRotationPoint(0.0F, 2.5F, 0.0F);
    this.rightlowleg.addChild(this.ironrightlegarmor);

    this.goldrightlegarmor = new ModelRenderer(this, 112, 181);
    this.goldrightlegarmor.addBox(-2.0F, -2.5F, -2.0F, 4, 5, 4);
    this.goldrightlegarmor.setRotationPoint(0.0F, 2.5F, 0.0F);
    this.rightlowleg.addChild(this.goldrightlegarmor);

    this.diamondrightlegarmor = new ModelRenderer(this, 43, 215);
    this.diamondrightlegarmor.addBox(-2.0F, -2.5F, -2.0F, 4, 5, 4);
    this.diamondrightlegarmor.setRotationPoint(0.0F, 2.5F, 0.0F);
    this.rightlowleg.addChild(this.diamondrightlegarmor);

    this.storage = new ModelRenderer(this, 28, 59);
    this.storage.addBox(-5.0F, -4.5F, 1.5F, 10, 5, 6);
    this.storage.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.storage, -0.2268928F, 0.0F, 0.0F);

    this.chestbelt = new ModelRenderer(this, 0, 201);
    this.chestbelt.addBox(-5.5F, -0.5F, -9.0F, 11, 11, 2);
    this.chestbelt.setRotationPoint(0.0F, 0.0F, 0.0F);

    this.stomachbelt = new ModelRenderer(this, 0, 201);
    this.stomachbelt.addBox(-5.5F, -0.5F, -3.0F, 11, 11, 2);
    this.stomachbelt.setRotationPoint(0.0F, 0.0F, 0.0F);

    this.ironchestarmor = new ModelRenderer(this, 0, 128);
    this.ironchestarmor.addBox(-5.5F, 2.2F, -13.5F, 11, 11, 5);
    this.ironchestarmor.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.ironchestarmor, -0.2602503F, 0.0F, 0.0F);

    this.ironrightshoulderpad = new ModelRenderer(this, 74, 201);
    this.ironrightshoulderpad.addBox(-6.5F, 0.5F, -13.0F, 5, 6, 6);
    this.ironrightshoulderpad.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.ironrightshoulderpad, -0.2617994F, 0.0F, 0.0F);

    this.ironleftshoulderpad = new ModelRenderer(this, 26, 201);
    this.ironleftshoulderpad.addBox(1.5F, 0.5F, -13.0F, 5, 6, 6);
    this.ironleftshoulderpad.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.ironleftshoulderpad, -0.2617994F, 0.0F, 0.0F);

    this.goldleftshoulder = new ModelRenderer(this, 71, 244);
    this.goldleftshoulder.addBox(1.5F, 0.5F, -13.0F, 5, 6, 6);
    this.goldleftshoulder.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.goldchestarmor.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.goldchestarmor, -0.2602503F, 0.0F, 0.0F);

    this.goldrightshoulder = new ModelRenderer(this, 93, 244);
    this.goldrightshoulder.addBox(-6.5F, 0.5F, -13.0F, 5, 6, 6);
    this.goldrightshoulder.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.goldrightshoulder, -0.2617994F, 0.0F, 0.0F);

    this.diamondleftshoulder = new ModelRenderer(this, 0, 244);
    this.diamondleftshoulder.addBox(1.5F, 0.5F, -13.0F, 5, 6, 6);
    this.diamondleftshoulder.setRotationPoint(0.0F, 0.0F, 0.0F);
    setRotation(this.diamondleftshoulder, -0.2617994F, 0.0F, 0.0F);

    this.diamondrightshoulder = new ModelRenderer(this, 22, 244);
    this.diamondrightshoulder.addBox(-6.5F, 0.5F, -13.0F, 5, 6, 6);
    this.diamondrightshoulder.setRotationPoint(0.0F, 0.0F, 0.0F);
    ...
    this.diamondchestarmor.setRotationPoint(0.0F, 0.0F, 0.0F);
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    if (this.isSaddled) {
      ...
      this.mouthrod.isHidden = false;
      this.helmetstrap1.isHidden = false;
      this.helmetstrap2.isHidden = false;
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    this.neck2.rotateAngleX = -66.0F / this.radianF + f4 * 1.0F / 3.0F / this.radianF;
    this.neck1.rotateAngleX = 30.0F / this.radianF + f4 * 2.0F / 3.0F / this.radianF;

    this.head.rotateAngleX = 45.0F / this.radianF;

    this.neck2.rotateAngleY = f3 * 2.0F / 3.0F / this.radianF;
    this.neck1.rotateAngleY = f3 * 1.0F / 3.0F / this.radianF;
    ...
    if (this.isRidden) {
      ...
      if (this.onAir) {
        ...
        this.neck2.rotateAngleX = -66.0F / this.radianF + RLegXRot * 1.0F / 60.0F;
        this.neck1.rotateAngleX = 30.0F / this.radianF + RLegXRot * 2.0F / 60.0F;
      }
    }
    float TailXRot = MathHelper.cos(f * 0.4F) * 0.2F * f1;
    this.tail1.rotateAngleX = -19.0F / this.radianF;
    this.tail2.rotateAngleX = -16.0F / this.radianF;
    this.tail3.rotateAngleX = 7.0F / this.radianF;
    this.tail4.rotateAngleX = 11.0F / this.radianF;
    this.tail5.rotateAngleX = 8.0F / this.radianF;
    ...
    if (this.flapwings && !this.isGhost) {
      WingSpread = MathHelper.cos(f2 * 0.3F + 3.141593F) * 1.2F;

    }
    else {

      WingSpread = MathHelper.cos(f * 0.5F) * 0.1F;
    }
    ...
    if (this.onAir || this.isGhost) {
      ...
      this.leftuparm.rotateAngleZ = WingSpread * 2.0F / 3.0F;
      this.rightuparm.rotateAngleZ = -WingSpread * 2.0F / 3.0F;
      this.leftlowarm.rotateAngleZ = WingSpread * 0.1F;
      this.leftfing1a.rotateAngleZ = WingSpread * 1.0F;
      this.leftfing2a.rotateAngleZ = WingSpread * 0.8F;

      this.rightlowarm.rotateAngleZ = -WingSpread * 0.1F;
      this.rightfing1a.rotateAngleZ = -WingSpread * 1.0F;
      this.rightfing2a.rotateAngleZ = -WingSpread * 0.8F;


      this.leftuparm.rotateAngleY = -10.0F / this.radianF - WingSpread / 2.5F;
      this.leftlowarm.rotateAngleY = 15.0F / this.radianF + WingSpread / 2.5F;
      this.leftfing1a.rotateAngleY = 70.0F / this.radianF;
      this.leftfing2a.rotateAngleY = 35.0F / this.radianF;
      this.leftfing3a.rotateAngleY = -5.0F / this.radianF;
      this.rightuparm.rotateAngleY = 10.0F / this.radianF + WingSpread / 2.5F;
      this.rightlowarm.rotateAngleY = -15.0F / this.radianF - WingSpread / 2.5F;
      this.rightfing1a.rotateAngleY = -70.0F / this.radianF;
      this.rightfing2a.rotateAngleY = -35.0F / this.radianF;
      this.rightfing3a.rotateAngleY = 5.0F / this.radianF;

      this.leftupleg.rotateAngleX = speedMov;
      this.leftmidleg.rotateAngleX = speedMov;
      this.leftfoot.rotateAngleX = 25.0F / this.radianF;
      this.lefttoe1.rotateAngleX = speedMov;
      this.lefttoe2.rotateAngleX = speedMov;
      this.lefttoe3.rotateAngleX = speedMov;
      this.rightfoot.rotateAngleX = 25.0F / this.radianF;
      ...
      this.leftlowarm.rotateAngleZ = 0.0F;
      this.leftfing1a.rotateAngleZ = 0.0F;
      this.leftfing2a.rotateAngleZ = 0.0F;
      this.rightlowarm.rotateAngleZ = 0.0F;
      this.rightfing1a.rotateAngleZ = 0.0F;
      this.rightfing2a.rotateAngleZ = 0.0F;



      this.leftuparm.rotateAngleZ = 30.0F / this.radianF;
      this.leftuparm.rotateAngleY = -60.0F / this.radianF + LLegXRot / 5.0F;

      this.leftlowarm.rotateAngleY = 105.0F / this.radianF;
      this.leftfing1a.rotateAngleY = -20.0F / this.radianF;
      this.leftfing2a.rotateAngleY = -26.0F / this.radianF;
      this.leftfing3a.rotateAngleY = -32.0F / this.radianF;

      this.rightuparm.rotateAngleY = 60.0F / this.radianF - RLegXRot / 5.0F;
      this.rightuparm.rotateAngleZ = -30.0F / this.radianF;

      this.rightlowarm.rotateAngleY = -105.0F / this.radianF;
      this.rightfing1a.rotateAngleY = 16.0F / this.radianF;
      this.rightfing2a.rotateAngleY = 26.0F / this.radianF;
      this.rightfing3a.rotateAngleY = 32.0F / this.radianF;



      this.leftupleg.rotateAngleX = -25.0F / this.radianF + LLegXRot;
      this.rightupleg.rotateAngleX = -25.0F / this.radianF + RLegXRot;

      this.leftmidleg.rotateAngleX = 0.0F;
      this.leftlowleg.rotateAngleX = 0.0F;
      this.leftfoot.rotateAngleX = 25.0F / this.radianF - LLegXRot;
      this.lefttoe1.rotateAngleX = LLegXRot;
      this.lefttoe2.rotateAngleX = LLegXRot;
      this.lefttoe3.rotateAngleX = LLegXRot;

      this.rightmidleg.rotateAngleX = 0.0F;
      this.rightlowleg.rotateAngleX = 0.0F;
      this.rightfoot.rotateAngleX = 25.0F / this.radianF - RLegXRot;
    ...
    if (this.isSitting) {
      this.leftupleg.rotateAngleX = 45.0F / this.radianF + LLegXRot;
      this.rightupleg.rotateAngleX = 45.0F / this.radianF + RLegXRot;
      this.leftmidleg.rotateAngleX = 30.0F;
      this.rightmidleg.rotateAngleX = 30.0F;
      this.neck2.rotateAngleX = -36.0F / this.radianF + f4 * 1.0F / 3.0F / this.radianF;
      this.neck1.rotateAngleX = 30.0F / this.radianF + f4 * 2.0F / 3.0F / this.radianF;
    }
    if (this.diving) {
      this.leftuparm.rotateAngleZ = -40.0F / this.radianF;
      this.rightuparm.rotateAngleZ = 40.0F / this.radianF;
      this.leftlowarm.rotateAngleZ = 0.0F;
      this.leftfing1a.rotateAngleZ = 0.0F;
      this.leftfing2a.rotateAngleZ = 0.0F;
      ...
      this.leftuparm.rotateAngleY = -50.0F / this.radianF;
      this.leftlowarm.rotateAngleY = 30.0F / this.radianF;
      this.leftfing1a.rotateAngleY = 50.0F / this.radianF;
      this.leftfing2a.rotateAngleY = 30.0F / this.radianF;
      this.leftfing3a.rotateAngleY = 10.0F / this.radianF;

      this.rightuparm.rotateAngleY = 50.0F / this.radianF;


      this.rightlowarm.rotateAngleY = -30.0F / this.radianF;
      this.rightfing1a.rotateAngleY = -50.0F / this.radianF;
      this.rightfing2a.rotateAngleY = -30.0F / this.radianF;
      this.rightfing3a.rotateAngleY = -10.0F / this.radianF;
    }

    if (this.openMouth != 0) {
      float mouthMov = MathHelper.cos((this.openMouth - 15) * 0.11F) * 0.8F;
      this.Jaw.rotateAngleX = -10.0F / this.radianF + mouthMov;
      this.leftearskin.rotateAngleY = mouthMov;
      this.rightearskin.rotateAngleY = -mouthMov;
    } else {

      this.Jaw.rotateAngleX = -10.0F / this.radianF;
      this.leftearskin.rotateAngleY = 0.0F;
      this.rightearskin.rotateAngleY = 0.0F;
    }
  }
}
