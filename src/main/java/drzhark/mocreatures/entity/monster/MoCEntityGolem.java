...
/*     */
/* 141 */         int freq = 21 - getGolemState() * this.world.getDifficulty().getDifficultyId() ;
...
/* 288 */         int h = this.world.getDifficulty().getDifficultyId() ;
...
/* 380 */       int j = this.world.getDifficulty().getDifficultyId() ;
...
/* 388 */       if (entity != this && this.world.getDifficulty().getDifficultyId()  > 0 && entity instanceof EntityLivingBase) {
...
/* 400 */       if (entity != this && this.world.getDifficulty().getDifficultyId()  > 0 && entity instanceof EntityLivingBase) {
...
/* 409 */       if (entity != this && this.world.getDifficulty().getDifficultyId()  > 0 && entity instanceof EntityLivingBase) {
