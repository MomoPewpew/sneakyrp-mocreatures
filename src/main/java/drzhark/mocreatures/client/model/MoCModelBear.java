  ...
  extends ModelBase
{
  ...
  public MoCModelBear() {
    ...
    this.Head.addBox(-4.0F, 0.0F, -4.0F, 8, 8, 5);
    ...
    this.Mouth.addBox(-1.5F, 6.0F, -6.8F, 3, 2, 5);
    this.Mouth.setRotationPoint(0.0F, 6.0F, -10.0F);
    setRotation(this.Mouth, -0.0068161F, 0.0F, 0.0F);

    this.MouthOpen = new ModelRenderer(this, 24, 21);
    this.MouthOpen.addBox(-1.5F, 4.0F, -9.5F, 3, 2, 5);
    this.MouthOpen.setRotationPoint(0.0F, 6.0F, -10.0F);
    setRotation(this.MouthOpen, 0.534236F, 0.0F, 0.0F);

    this.LEar = new ModelRenderer(this, 40, 0);
    this.LEar.addBox(2.0F, -2.0F, -2.0F, 3, 3, 1);
    this.LEar.setRotationPoint(0.0F, 6.0F, -10.0F);
    setRotation(this.LEar, 0.1502636F, -0.3490659F, 0.1396263F);

    this.REar = new ModelRenderer(this, 16, 0);
    this.REar.addBox(-5.0F, -2.0F, -2.0F, 3, 3, 1);
    this.REar.setRotationPoint(0.0F, 6.0F, -10.0F);
    setRotation(this.REar, 0.1502636F, 0.3490659F, -0.1396263F);

    this.Snout = new ModelRenderer(this, 23, 13);
    this.Snout.addBox(-2.0F, 3.0F, -8.0F, 4, 3, 5);
    this.Snout.setRotationPoint(0.0F, 6.0F, -10.0F);
    setRotation(this.Snout, 0.1502636F, 0.0F, 0.0F);

    this.Neck = new ModelRenderer(this, 18, 28);
    this.Neck.addBox(-3.5F, 0.0F, -7.0F, 7, 7, 7);
    ...
    this.Abdomen.addBox(-4.5F, 0.0F, 0.0F, 9, 11, 10);
    this.Abdomen.setRotationPoint(0.0F, 5.0F, 5.0F);
    setRotation(this.Abdomen, -0.4363323F, 0.0F, 0.0F);

    this.Torso = new ModelRenderer(this, 12, 42);
    this.Torso.addBox(-5.0F, 0.0F, 0.0F, 10, 10, 10);
    this.Torso.setRotationPoint(0.0F, 5.0F, -5.0F);

    this.Tail = new ModelRenderer(this, 26, 83);
    this.Tail.addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3);
    this.Tail.setRotationPoint(0.0F, 8.466666F, 12.0F);
    setRotation(this.Tail, 0.4363323F, 0.0F, 0.0F);

    this.LegFL1 = new ModelRenderer(this, 40, 22);
    this.LegFL1.addBox(-2.5F, 0.0F, -2.5F, 5, 8, 5);
    this.LegFL1.setRotationPoint(4.0F, 10.0F, -4.0F);
    setRotation(this.LegFL1, 0.2617994F, 0.0F, 0.0F);

    this.LegFL2 = new ModelRenderer(this, 46, 35);
    this.LegFL2.addBox(-2.0F, 7.0F, 0.0F, 4, 6, 4);
    this.LegFL2.setRotationPoint(4.0F, 10.0F, -4.0F);

    this.LegFL3 = new ModelRenderer(this, 46, 45);
    this.LegFL3.addBox(-2.0F, 12.0F, -1.0F, 4, 2, 5);
    this.LegFL3.setRotationPoint(4.0F, 10.0F, -4.0F);

    this.LegFR1 = new ModelRenderer(this, 4, 22);
    this.LegFR1.addBox(-2.5F, 0.0F, -2.5F, 5, 8, 5);
    this.LegFR1.setRotationPoint(-4.0F, 10.0F, -4.0F);
    setRotation(this.LegFR1, 0.2617994F, 0.0F, 0.0F);

    this.LegFR2 = new ModelRenderer(this, 2, 35);
    this.LegFR2.addBox(-2.0F, 7.0F, 0.0F, 4, 6, 4);
    this.LegFR2.setRotationPoint(-4.0F, 10.0F, -4.0F);

    this.LegFR3 = new ModelRenderer(this, 0, 45);
    this.LegFR3.addBox(-2.0F, 12.0F, -1.0F, 4, 2, 5);
    this.LegFR3.setRotationPoint(-4.0F, 10.0F, -4.0F);

    this.LegRL1 = new ModelRenderer(this, 34, 83);
    this.LegRL1.addBox(-1.5F, 0.0F, -2.5F, 4, 8, 6);
    this.LegRL1.setRotationPoint(3.5F, 11.0F, 9.0F);
    setRotation(this.LegRL1, -0.1745329F, 0.0F, 0.0F);

    this.LegRL2 = new ModelRenderer(this, 41, 97);
    this.LegRL2.addBox(-2.0F, 6.0F, -1.0F, 4, 6, 4);
    this.LegRL2.setRotationPoint(3.5F, 11.0F, 9.0F);

    this.LegRL3 = new ModelRenderer(this, 44, 107);
    this.LegRL3.addBox(-2.0F, 11.0F, -2.0F, 4, 2, 5);
    this.LegRL3.setRotationPoint(3.5F, 11.0F, 9.0F);

    this.LegRR1 = new ModelRenderer(this, 10, 83);
    this.LegRR1.addBox(-2.5F, 0.0F, -2.5F, 4, 8, 6);
    this.LegRR1.setRotationPoint(-3.5F, 11.0F, 9.0F);
    setRotation(this.LegRR1, -0.1745329F, 0.0F, 0.0F);

    this.LegRR2 = new ModelRenderer(this, 7, 97);
    this.LegRR2.addBox(-2.0F, 6.0F, -1.0F, 4, 6, 4);
    this.LegRR2.setRotationPoint(-3.5F, 11.0F, 9.0F);

    this.LegRR3 = new ModelRenderer(this, 2, 107);
    this.LegRR3.addBox(-2.0F, 11.0F, -2.0F, 4, 2, 5);
    this.LegRR3.setRotationPoint(-3.5F, 11.0F, 9.0F);



    this.BHead = new ModelRenderer(this, 19, 0);
    this.BHead.addBox(-4.0F, 0.0F, -4.0F, 8, 8, 5);
    this.BHead.setRotationPoint(0.0F, -12.0F, 5.0F);
    setRotation(this.BHead, -0.0242694F, 0.0F, 0.0F);

    this.BSnout = new ModelRenderer(this, 23, 13);
    this.BSnout.addBox(-2.0F, 2.5F, -8.5F, 4, 3, 5);
    this.BSnout.setRotationPoint(0.0F, -12.0F, 5.0F);
    ...
    this.BMouth.setRotationPoint(0.0F, -12.0F, 5.0F);
    setRotation(this.BMouth, -0.08726F, 0.0F, 0.0F);

    this.BMouthOpen = new ModelRenderer(this, 24, 21);
    this.BMouthOpen.addBox(-1.5F, 3.5F, -11.0F, 3, 2, 5);
    this.BMouthOpen.setRotationPoint(0.0F, -12.0F, 5.0F);
    setRotation(this.BMouthOpen, 0.5235988F, 0.0F, 0.0F);

    this.BNeck = new ModelRenderer(this, 18, 28);
    this.BNeck.addBox(-3.5F, 0.0F, -7.0F, 7, 6, 7);
    this.BNeck.setRotationPoint(0.0F, -3.0F, 11.0F);
    setRotation(this.BNeck, -1.336881F, 0.0F, 0.0F);

    this.BLEar = new ModelRenderer(this, 40, 0);
    this.BLEar.addBox(2.0F, -2.0F, -2.0F, 3, 3, 1);
    this.BLEar.setRotationPoint(0.0F, -12.0F, 5.0F);
    setRotation(this.BLEar, -0.0242694F, -0.3490659F, 0.1396263F);

    this.BREar = new ModelRenderer(this, 16, 0);
    this.BREar.addBox(-5.0F, -2.0F, -2.0F, 3, 3, 1);
    this.BREar.setRotationPoint(0.0F, -12.0F, 5.0F);
    setRotation(this.BREar, -0.0242694F, 0.3490659F, -0.1396263F);

    this.BTorso = new ModelRenderer(this, 12, 42);
    this.BTorso.addBox(-5.0F, 0.0F, 0.0F, 10, 10, 10);
    this.BTorso.setRotationPoint(0.0F, -3.5F, 12.3F);
    setRotation(this.BTorso, -1.396263F, 0.0F, 0.0F);

    this.BAbdomen = new ModelRenderer(this, 13, 62);
    this.BAbdomen.addBox(-4.5F, 0.0F, 0.0F, 9, 11, 10);
    this.BAbdomen.setRotationPoint(0.0F, 6.0F, 14.0F);
    setRotation(this.BAbdomen, -1.570796F, 0.0F, 0.0F);

    this.BTail = new ModelRenderer(this, 26, 83);
    this.BTail.addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3);
    this.BTail.setRotationPoint(0.0F, 12.46667F, 12.6F);
    setRotation(this.BTail, 0.3619751F, 0.0F, 0.0F);

    this.BLegFL1 = new ModelRenderer(this, 40, 22);
    this.BLegFL1.addBox(-2.5F, 0.0F, -2.5F, 5, 8, 5);
    this.BLegFL1.setRotationPoint(5.0F, -1.0F, 6.0F);
    setRotation(this.BLegFL1, 0.2617994F, 0.0F, -0.2617994F);

    this.BLegFL2 = new ModelRenderer(this, 46, 35);
    this.BLegFL2.addBox(0.0F, 5.0F, 3.0F, 4, 6, 4);
    this.BLegFL2.setRotationPoint(5.0F, -1.0F, 6.0F);
    setRotation(this.BLegFL2, -0.5576792F, 0.0F, 0.0F);

    this.BLegFL3 = new ModelRenderer(this, 46, 45);
    this.BLegFL3.addBox(0.1F, -7.0F, -14.0F, 4, 2, 5);
    this.BLegFL3.setRotationPoint(5.0F, -1.0F, 6.0F);
    setRotation(this.BLegFL3, 2.007645F, 0.0F, 0.0F);

    this.BLegFR1 = new ModelRenderer(this, 4, 22);
    this.BLegFR1.addBox(-2.5F, 0.0F, -2.5F, 5, 8, 5);
    this.BLegFR1.setRotationPoint(-5.0F, -1.0F, 6.0F);
    setRotation(this.BLegFR1, 0.2617994F, 0.0F, 0.2617994F);

    this.BLegFR2 = new ModelRenderer(this, 2, 35);
    this.BLegFR2.addBox(-4.0F, 5.0F, 3.0F, 4, 6, 4);
    this.BLegFR2.setRotationPoint(-5.0F, -1.0F, 6.0F);
    setRotation(this.BLegFR2, -0.5576792F, 0.0F, 0.0F);

    this.BLegFR3 = new ModelRenderer(this, 0, 45);
    this.BLegFR3.addBox(-4.1F, -7.0F, -14.0F, 4, 2, 5);
    this.BLegFR3.setRotationPoint(-5.0F, -1.0F, 6.0F);
    setRotation(this.BLegFR3, 2.007129F, 0.0F, 0.0F);

    this.BLegRL1 = new ModelRenderer(this, 34, 83);
    this.BLegRL1.addBox(-1.5F, 0.0F, -2.5F, 4, 8, 6);
    this.BLegRL1.setRotationPoint(3.0F, 11.0F, 9.0F);
    setRotation(this.BLegRL1, -0.5235988F, -0.2617994F, 0.0F);

    this.BLegRL2 = new ModelRenderer(this, 41, 97);
    this.BLegRL2.addBox(-1.3F, 6.0F, -3.0F, 4, 6, 4);
    this.BLegRL2.setRotationPoint(3.0F, 11.0F, 9.0F);
    setRotation(this.BLegRL2, 0.0F, -0.2617994F, 0.0F);

    this.BLegRL3 = new ModelRenderer(this, 44, 107);
    this.BLegRL3.addBox(-1.2F, 11.0F, -4.0F, 4, 2, 5);
    this.BLegRL3.setRotationPoint(3.0F, 11.0F, 9.0F);
    setRotation(this.BLegRL3, 0.0F, -0.2617994F, 0.0F);

    this.BLegRR1 = new ModelRenderer(this, 10, 83);
    this.BLegRR1.addBox(-2.5F, 0.0F, -2.5F, 4, 8, 6);
    this.BLegRR1.setRotationPoint(-3.0F, 11.0F, 9.0F);
    setRotation(this.BLegRR1, -0.1745329F, 0.2617994F, 0.0F);

    this.BLegRR2 = new ModelRenderer(this, 7, 97);
    this.BLegRR2.addBox(-2.4F, 6.0F, -1.0F, 4, 6, 4);
    this.BLegRR2.setRotationPoint(-3.0F, 11.0F, 9.0F);
    setRotation(this.BLegRR2, 0.0F, 0.2617994F, 0.0F);

    this.BLegRR3 = new ModelRenderer(this, 2, 107);
    this.BLegRR3.addBox(-2.5F, 11.0F, -2.0F, 4, 2, 5);
    this.BLegRR3.setRotationPoint(-3.0F, 11.0F, 9.0F);
    setRotation(this.BLegRR3, 0.0F, 0.2617994F, 0.0F);


    this.CHead = new ModelRenderer(this, 19, 0);
    this.CHead.addBox(-4.0F, 0.0F, -4.0F, 8, 8, 5);
    this.CHead.setRotationPoint(0.0F, 3.0F, -3.5F);
    setRotation(this.CHead, 0.1502636F, 0.0F, 0.0F);

    this.CSnout = new ModelRenderer(this, 23, 13);
    this.CSnout.addBox(-2.0F, 3.0F, -8.5F, 4, 3, 5);
    this.CSnout.setRotationPoint(0.0F, 3.0F, -3.5F);
    setRotation(this.CSnout, 0.1502636F, 0.0F, 0.0F);

    this.CMouth = new ModelRenderer(this, 24, 21);
    this.CMouth.addBox(-1.5F, 6.0F, -7.0F, 3, 2, 5);
    this.CMouth.setRotationPoint(0.0F, 3.0F, -3.5F);
    setRotation(this.CMouth, -0.0068161F, 0.0F, 0.0F);

    this.CMouthOpen = new ModelRenderer(this, 24, 21);
    this.CMouthOpen.addBox(-1.5F, 5.5F, -9.0F, 3, 2, 5);
    this.CMouthOpen.setRotationPoint(0.0F, 3.0F, -3.5F);
    setRotation(this.CMouthOpen, 0.3665191F, 0.0F, 0.0F);

    this.CLEar = new ModelRenderer(this, 40, 0);
    this.CLEar.addBox(2.0F, -2.0F, -2.0F, 3, 3, 1);
    this.CLEar.setRotationPoint(0.0F, 3.0F, -3.5F);
    setRotation(this.CLEar, 0.1502636F, -0.3490659F, 0.1396263F);

    this.CREar = new ModelRenderer(this, 16, 0);
    this.CREar.addBox(-5.0F, -2.0F, -2.0F, 3, 3, 1);
    this.CREar.setRotationPoint(0.0F, 3.0F, -3.5F);
    setRotation(this.CREar, 0.1502636F, 0.3490659F, -0.1396263F);

    this.CNeck = new ModelRenderer(this, 18, 28);
    this.CNeck.addBox(-3.5F, 0.0F, -7.0F, 7, 7, 7);
    this.CNeck.setRotationPoint(0.0F, 5.8F, 3.4F);
    setRotation(this.CNeck, -0.3316126F, 0.0F, 0.0F);

    this.CTorso = new ModelRenderer(this, 12, 42);
    this.CTorso.addBox(-5.0F, 0.0F, 0.0F, 10, 10, 10);
    this.CTorso.setRotationPoint(0.0F, 5.8F, 3.4F);
    setRotation(this.CTorso, -0.9712912F, 0.0F, 0.0F);

    this.CAbdomen = new ModelRenderer(this, 13, 62);
    this.CAbdomen.addBox(-4.5F, 0.0F, 0.0F, 9, 11, 10);
    this.CAbdomen.setRotationPoint(0.0F, 14.0F, 9.0F);
    setRotation(this.CAbdomen, -1.570796F, 0.0F, 0.0F);

    this.CTail = new ModelRenderer(this, 26, 83);
    this.CTail.addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3);
    this.CTail.setRotationPoint(0.0F, 21.46667F, 8.0F);
    setRotation(this.CTail, 0.4363323F, 0.0F, 0.0F);

    this.CLegFL1 = new ModelRenderer(this, 40, 22);
    this.CLegFL1.addBox(-2.5F, 0.0F, -1.5F, 5, 8, 5);
    this.CLegFL1.setRotationPoint(4.0F, 10.0F, 0.0F);
    setRotation(this.CLegFL1, -0.2617994F, 0.0F, 0.0F);

    this.CLegFL2 = new ModelRenderer(this, 46, 35);
    this.CLegFL2.addBox(-2.0F, 0.0F, -1.2F, 4, 6, 4);
    this.CLegFL2.setRotationPoint(4.0F, 17.0F, -2.0F);
    setRotation(this.CLegFL2, -0.3490659F, 0.0F, 0.2617994F);

    this.CLegFL3 = new ModelRenderer(this, 46, 45);
    this.CLegFL3.addBox(-2.0F, 0.0F, -3.0F, 4, 2, 5);
    this.CLegFL3.setRotationPoint(2.5F, 22.0F, -4.0F);
    setRotation(this.CLegFL3, 0.0F, 0.1745329F, 0.0F);

    this.CLegFR1 = new ModelRenderer(this, 4, 22);
    this.CLegFR1.addBox(-2.5F, 0.0F, -1.5F, 5, 8, 5);
    this.CLegFR1.setRotationPoint(-4.0F, 10.0F, 0.0F);
    setRotation(this.CLegFR1, -0.2617994F, 0.0F, 0.0F);

    this.CLegFR2 = new ModelRenderer(this, 2, 35);
    this.CLegFR2.addBox(-2.0F, 0.0F, -1.2F, 4, 6, 4);
    this.CLegFR2.setRotationPoint(-4.0F, 17.0F, -2.0F);
    setRotation(this.CLegFR2, -0.3490659F, 0.0F, -0.2617994F);

    this.CLegFR3 = new ModelRenderer(this, 0, 45);
    this.CLegFR3.addBox(-2.0F, 0.0F, -3.0F, 4, 2, 5);
    this.CLegFR3.setRotationPoint(-2.5F, 22.0F, -4.0F);
    setRotation(this.CLegFR3, 0.0F, -0.1745329F, 0.0F);

    this.CLegRL1 = new ModelRenderer(this, 34, 83);
    this.CLegRL1.addBox(-1.5F, 0.0F, -2.5F, 4, 8, 6);
    this.CLegRL1.setRotationPoint(3.0F, 21.0F, 5.0F);
    setRotation(this.CLegRL1, -1.396263F, -0.3490659F, 0.3490659F);

    this.CLegRL2 = new ModelRenderer(this, 41, 97);
    this.CLegRL2.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4);
    this.CLegRL2.setRotationPoint(5.2F, 22.5F, -1.0F);
    setRotation(this.CLegRL2, -1.570796F, 0.0F, 0.3490659F);

    this.CLegRL3 = new ModelRenderer(this, 44, 107);
    this.CLegRL3.addBox(-2.0F, 0.0F, -3.0F, 4, 2, 5);
    this.CLegRL3.setRotationPoint(5.5F, 22.0F, -6.0F);
    setRotation(this.CLegRL3, -1.375609F, 0.0F, 0.3490659F);

    this.CLegRR1 = new ModelRenderer(this, 10, 83);
    this.CLegRR1.addBox(-2.5F, 0.0F, -2.5F, 4, 8, 6);
    this.CLegRR1.setRotationPoint(-3.0F, 21.0F, 5.0F);
    setRotation(this.CLegRR1, -1.396263F, 0.3490659F, -0.3490659F);

    this.CLegRR2 = new ModelRenderer(this, 7, 97);
    this.CLegRR2.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4);
    this.CLegRR2.setRotationPoint(-5.2F, 22.5F, -1.0F);
    setRotation(this.CLegRR2, -1.570796F, 0.0F, -0.3490659F);

    this.CLegRR3 = new ModelRenderer(this, 2, 107);
    this.CLegRR3.addBox(-2.0F, 0.0F, -3.0F, 4, 2, 5);
    this.CLegRR3.setRotationPoint(-5.5F, 22.0F, -6.0F);
    setRotation(this.CLegRR3, -1.375609F, 0.0F, -0.3490659F);

    this.Saddle = new ModelRenderer(this, 36, 114);
    this.Saddle.addBox(-4.0F, -0.5F, -3.0F, 8, 2, 6, 0.0F);
    this.Saddle.setRotationPoint(0.0F, 4.0F, -2.0F);

    this.SaddleBack = new ModelRenderer(this, 20, 108);
    this.SaddleBack.addBox(-4.0F, -0.2F, 2.9F, 8, 2, 4, 0.0F);
    this.SaddleBack.setRotationPoint(0.0F, 4.0F, -2.0F);
    this.SaddleBack.rotateAngleX = 0.10088F;

    this.SaddleFront = new ModelRenderer(this, 36, 122);
    this.SaddleFront.addBox(-2.5F, -1.0F, -3.0F, 5, 2, 3, 0.0F);
    this.SaddleFront.setRotationPoint(0.0F, 4.0F, -2.0F);
    this.SaddleFront.rotateAngleX = -0.1850049F;

    this.Bag = new ModelRenderer(this, 0, 114);
    this.Bag.addBox(-5.0F, -3.0F, -2.5F, 10, 2, 5, 0.0F);
    this.Bag.setRotationPoint(0.0F, 7.0F, 7.0F);
    this.Bag.rotateAngleX = -0.4363323F;

    this.BagSitted = new ModelRenderer(this, 0, 114);
    this.BagSitted.addBox(-5.0F, -3.0F, -2.5F, 10, 2, 5, 0.0F);
    this.BagSitted.setRotationPoint(0.0F, 17.0F, 8.0F);
    this.BagSitted.rotateAngleX = -1.570796F;

    this.SaddleSitted = new ModelRenderer(this, 36, 114);
    this.SaddleSitted.addBox(-4.0F, -0.5F, -3.0F, 8, 2, 6, 0.0F);
    this.SaddleSitted.setRotationPoint(0.0F, 7.5F, 6.5F);
    this.SaddleSitted.rotateAngleX = -0.9686577F;

    this.SaddleBackSitted = new ModelRenderer(this, 20, 108);
    this.SaddleBackSitted.addBox(-4.0F, -0.3F, 2.9F, 8, 2, 4, 0.0F);
    this.SaddleBackSitted.setRotationPoint(0.0F, 7.5F, 6.5F);
    this.SaddleBackSitted.rotateAngleX = -0.9162979F;

    this.SaddleFrontSitted = new ModelRenderer(this, 36, 122);
    this.SaddleFrontSitted.addBox(-2.5F, -1.0F, -3.0F, 5, 2, 3, 0.0F);
    this.SaddleFrontSitted.setRotationPoint(0.0F, 7.5F, 6.5F);
    this.SaddleFrontSitted.rotateAngleX = -1.151917F;
  }
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    if (this.bearstate == 0) {
      ...
      if (saddled) {
        ...
        this.SaddleBack.render(f5);
        this.SaddleFront.render(f5);
      }
      if (chested)
      {
        this.Bag.render(f5);
      ...
      if (saddled) {
        ...
        this.SaddleSitted.render(f5);
        this.SaddleBackSitted.render(f5);
        this.SaddleFrontSitted.render(f5);
      }
      if (chested)
      {
        this.BagSitted.render(f5);
      }
