...
public class MoCModelSmallFish
  ...
  public MoCModelSmallFish() {
    ...
    this.BodyFlat.addBox(0.0F, -1.5F, -1.0F, 5, 3, 2);
    this.BodyFlat.setRotationPoint(-3.0F, 15.0F, 0.0F);

    this.BodyRomboid = new ModelRenderer(this, 0, 7);
    this.BodyRomboid.addBox(0.0F, 0.0F, -0.5F, 4, 4, 1);
    this.BodyRomboid.setRotationPoint(-4.0F, 15.0F, 0.0F);
    setRotation(this.BodyRomboid, 0.0F, 0.0F, -0.7853982F);

    this.MidBodyFin = new ModelRenderer(this, 0, 12);
    this.MidBodyFin.addBox(0.0F, -0.5F, 0.0F, 4, 2, 4);
    this.MidBodyFin.setRotationPoint(-3.0F, 15.0F, 0.0F);
    ...
    this.UpperFinA.setRotationPoint(-0.65F, 13.5F, 0.0F);

    this.UpperFinB = new ModelRenderer(this, 0, 0);
    this.UpperFinB.addBox(-2.5F, -1.0F, -0.5F, 4, 1, 1);
    this.UpperFinB.setRotationPoint(0.0F, 13.5F, 0.0F);
    this.UpperFinB.setTextureSize(32, 32);

    this.UpperFinC = new ModelRenderer(this, 0, 18);
    this.UpperFinC.addBox(-5.0F, -2.0F, 0.0F, 8, 3, 0);
    this.UpperFinC.setRotationPoint(0.0F, 13.5F, 0.0F);

    this.LowerFinA = new ModelRenderer(this, 16, 0);
    this.LowerFinA.addBox(-0.5F, -0.3F, -0.5F, 2, 1, 1);
    this.LowerFinA.setRotationPoint(-0.65F, 17.2F, 0.0F);

    this.LowerFinB = new ModelRenderer(this, 0, 21);
    this.LowerFinB.addBox(0.0F, 0.0F, -3.0F, 5, 0, 6);
    this.LowerFinB.setRotationPoint(-3.0F, 16.0F, 0.0F);

    this.LowerFinC = new ModelRenderer(this, 16, 18);
    this.LowerFinC.addBox(-5.0F, 0.0F, 0.0F, 8, 3, 0);
    this.LowerFinC.setRotationPoint(0.0F, 15.5F, 0.0F);
