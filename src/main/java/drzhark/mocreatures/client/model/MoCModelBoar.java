...
public class MoCModelBoar
  ...
  public MoCModelBoar() {
    ...
    this.Head.addBox(-3.0F, 0.0F, -5.0F, 6, 6, 5);
    ...
    this.BodyMane.addBox(-1.0F, -2.0F, -1.0F, 2, 2, 9);
    this.BodyMane.setRotationPoint(0.0F, 11.3F, -4.0F);
    setRotation(this.BodyMane, -0.2617994F, 0.0F, 0.0F);

    this.Tail = new ModelRenderer(this, 60, 38);
    this.Tail.addBox(-0.5F, 0.0F, 0.0F, 1, 5, 1);
    this.Tail.setRotationPoint(0.0F, 13.0F, 7.5F);
    setRotation(this.Tail, 0.0872665F, 0.0F, 0.0F);

    this.UpperLegRight = new ModelRenderer(this, 32, 21);
    this.UpperLegRight.addBox(-1.0F, -2.0F, -2.0F, 1, 5, 3);
    this.UpperLegRight.setRotationPoint(-3.5F, 16.0F, -2.5F);
    setRotation(this.UpperLegRight, 0.1745329F, 0.0F, 0.0F);

    this.LowerLegRight = new ModelRenderer(this, 32, 29);
    this.LowerLegRight.addBox(-0.5F, 2.0F, -1.0F, 2, 6, 2);
    this.LowerLegRight.setRotationPoint(-3.5F, 16.0F, -2.5F);

    this.UpperLegLeft = new ModelRenderer(this, 24, 21);
    this.UpperLegLeft.addBox(0.0F, -2.0F, -2.0F, 1, 5, 3);
    this.UpperLegLeft.setRotationPoint(3.5F, 16.0F, -2.5F);
    setRotation(this.UpperLegLeft, 0.1745329F, 0.0F, 0.0F);

    this.LowerLegLeft = new ModelRenderer(this, 24, 29);
    this.LowerLegLeft.addBox(-1.5F, 2.0F, -1.0F, 2, 6, 2);
    this.LowerLegLeft.setRotationPoint(3.5F, 16.0F, -2.5F);

    this.UpperHindLegRight = new ModelRenderer(this, 44, 21);
    this.UpperHindLegRight.addBox(-1.5F, -2.0F, -2.0F, 1, 5, 4);
    this.UpperHindLegRight.setRotationPoint(-3.0F, 16.0F, 5.5F);
    setRotation(this.UpperHindLegRight, -0.2617994F, 0.0F, 0.0F);

    this.LowerHindLegRight = new ModelRenderer(this, 46, 30);
    this.LowerHindLegRight.addBox(-1.0F, 2.0F, 0.0F, 2, 6, 2);
    this.LowerHindLegRight.setRotationPoint(-3.0F, 16.0F, 5.5F);

    this.UpperHindLegLeft = new ModelRenderer(this, 54, 21);
    this.UpperHindLegLeft.addBox(0.5F, -2.0F, -2.0F, 1, 5, 4);
    this.UpperHindLegLeft.setRotationPoint(3.0F, 16.0F, 5.5F);
    setRotation(this.UpperHindLegLeft, -0.2617994F, 0.0F, 0.0F);

    this.LowerHindLegLeft = new ModelRenderer(this, 56, 30);
    this.LowerHindLegLeft.addBox(-1.0F, 2.0F, 0.0F, 2, 6, 2);
    this.LowerHindLegLeft.setRotationPoint(3.0F, 16.0F, 5.5F);
  }
