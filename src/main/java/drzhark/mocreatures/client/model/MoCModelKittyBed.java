  ...
  extends ModelBase
{
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    if (!this.pickedUp) {
      ...
      if (this.hasMilk) {
        this.Milk.rotationPointY = 21.0F + this.milklevel;
        this.Milk.render(f5);
      }
      if (this.hasFood) {
        this.PetFood.rotationPointY = 21.0F + this.milklevel;
