...
/* 46 */       if (!getIsTamed() && ++this.poisoncounter > 250 && this.world.getDifficulty().getDifficultyId()  > 0 && this.rand.nextInt(30) == 0 &&
...
/* 72 */       if (this.world.getDifficulty().getDifficultyId()  == 0) {
/* 73 */         return true;
/*    */       }
