...
/* 1149 */     this.radianF = 57.29578F;
/*      */     this.textureWidth = 128;
/*      */     this.textureHeight = 128;
/*      */     this.UBeak = new ModelRenderer(this, 12, 16);
/*      */     this.UBeak.addBox(-1.5F, -15.0F, -5.5F, 3, 1, 1);
/*      */     this.UBeak.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.UBeak2 = new ModelRenderer(this, 20, 16);
/*      */     this.UBeak2.addBox(-1.0F, -15.0F, -7.5F, 2, 1, 2);
/*      */     this.UBeak2.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.UBeakb = new ModelRenderer(this, 12, 16);
/*      */     this.UBeakb.addBox(-1.5F, -15.0F, -6.5F, 3, 1, 1);
/*      */     this.UBeakb.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.UBeakb, -0.0698132F, 0.0F, 0.0F);
/*      */     this.UBeak2b = new ModelRenderer(this, 20, 16);
/*      */     this.UBeak2b.addBox(-1.0F, -15.0F, -8.5F, 2, 1, 2);
/*      */     this.UBeak2b.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.UBeak2b, -0.0698132F, 0.0F, 0.0F);
/*      */     this.LBeak = new ModelRenderer(this, 12, 22);
/*      */     this.LBeak.addBox(-1.5F, -14.0F, -5.5F, 3, 1, 1);
/*      */     this.LBeak.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.LBeakb = new ModelRenderer(this, 12, 22);
/*      */     this.LBeakb.addBox(-1.5F, -14.0F, -3.9F, 3, 1, 1);
/*      */     this.LBeakb.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.LBeakb, 0.122173F, 0.0F, 0.0F);
/*      */     this.LBeak2 = new ModelRenderer(this, 20, 22);
/*      */     this.LBeak2.addBox(-1.0F, -14.0F, -7.5F, 2, 1, 2);
/*      */     this.LBeak2.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.LBeak2b = new ModelRenderer(this, 20, 22);
/*      */     this.LBeak2b.addBox(-1.0F, -14.0F, -5.9F, 2, 1, 2);
/*      */     this.LBeak2b.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.LBeak2b, 0.122173F, 0.0F, 0.0F);
/*      */     this.Body = new ModelRenderer(this, 0, 38);
/*      */     this.Body.addBox(-4.0F, 1.0F, 0.0F, 8, 10, 16);
/*      */     this.Body.setRotationPoint(0.0F, 0.0F, -6.0F);
/*      */     this.LLegA = new ModelRenderer(this, 50, 28);
/*      */     this.LLegA.addBox(-2.0F, -1.0F, -2.5F, 4, 6, 5);
/*      */     this.LLegA.setRotationPoint(4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.LLegA, 0.1745329F, 0.0F, 0.0F);
/*      */     this.LLegB = new ModelRenderer(this, 50, 39);
/*      */     this.LLegB.addBox(-1.5F, 5.0F, -1.5F, 3, 4, 3);
/*      */     this.LLegB.setRotationPoint(4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.LLegB, 0.1745329F, 0.0F, 0.0F);
/*      */     this.LLegC = new ModelRenderer(this, 8, 38);
/*      */     this.LLegC.addBox(-1.0F, 8.0F, 2.5F, 2, 10, 2);
/*      */     this.LLegC.setRotationPoint(4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.LLegC, -0.2617994F, 0.0F, 0.0F);
/*      */     this.LFoot = new ModelRenderer(this, 32, 42);
/*      */     this.LFoot.addBox(-1.0F, 17.0F, -9.0F, 2, 1, 5);
/*      */     this.LFoot.setRotationPoint(4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.LFoot, 0.1745329F, 0.0F, 0.0F);
/*      */     this.RLegA = new ModelRenderer(this, 0, 27);
/*      */     this.RLegA.addBox(-2.0F, -1.0F, -2.5F, 4, 6, 5);
/*      */     this.RLegA.setRotationPoint(-4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.RLegA, 0.1745329F, 0.0F, 0.0F);
/*      */     this.RLegB = new ModelRenderer(this, 18, 27);
/*      */     this.RLegB.addBox(-1.5F, 5.0F, -1.5F, 3, 4, 3);
/*      */     this.RLegB.setRotationPoint(-4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.RLegB, 0.1745329F, 0.0F, 0.0F);
/*      */     this.RLegC = new ModelRenderer(this, 0, 38);
/*      */     this.RLegC.addBox(-1.0F, 8.0F, 2.5F, 2, 10, 2);
/*      */     this.RLegC.setRotationPoint(-4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.RLegC, -0.2617994F, 0.0F, 0.0F);
/*      */     this.RFoot = new ModelRenderer(this, 32, 48);
/*      */     this.RFoot.addBox(-1.0F, 17.0F, -9.0F, 2, 1, 5);
/*      */     this.RFoot.setRotationPoint(-4.0F, 5.0F, 4.0F);
/*      */     setRotation(this.RFoot, 0.1745329F, 0.0F, 0.0F);
/*      */     this.Tail1 = new ModelRenderer(this, 44, 18);
/*      */     this.Tail1.addBox(-0.5F, -2.0F, -2.0F, 1, 4, 6);
...
/*      */     this.Tail2.addBox(-2.6F, -2.0F, -2.0F, 1, 4, 6);
...
/*      */     this.Tail3.addBox(1.6F, -2.0F, -2.0F, 1, 4, 6);
/*      */     this.Tail3.setRotationPoint(0.0F, 4.0F, 15.0F);
/*      */     setRotation(this.Tail3, 0.3490659F, 0.2617994F, 0.0F);
/*      */     this.LWingB = new ModelRenderer(this, 68, 46);
/*      */     this.LWingB.addBox(-0.5F, -3.0F, 0.0F, 1, 4, 14);
/*      */     this.LWingB.setRotationPoint(4.0F, 4.0F, -3.0F);
/*      */     setRotation(this.LWingB, 0.0872665F, 0.0872665F, 0.0F);
/*      */     this.LWingC = new ModelRenderer(this, 98, 46);
/*      */     this.LWingC.addBox(-1.0F, 0.0F, 0.0F, 1, 4, 14);
/*      */     this.LWingC.setRotationPoint(4.0F, 4.0F, -3.0F);
/*      */     setRotation(this.LWingC, 0.0F, 0.0872665F, 0.0F);
/*      */     this.LWingD = new ModelRenderer(this, 26, 84);
/*      */     this.LWingD.addBox(0.0F, -1.0F, -1.0F, 15, 2, 2);
/*      */     this.LWingD.setRotationPoint(4.0F, 3.0F, -3.0F);
/*      */     setRotation(this.LWingD, 0.0F, 0.0F, -0.3490659F);
/*      */     this.LWingE = new ModelRenderer(this, 0, 103);
/*      */     this.LWingE.addBox(0.0F, 0.0F, 1.0F, 15, 0, 15);
/*      */     this.LWingE.setRotationPoint(4.0F, 3.0F, -3.0F);
/*      */     setRotation(this.LWingE, 0.0F, 0.0F, -0.3490659F);
/*      */     this.RWingB = new ModelRenderer(this, 68, 0);
/*      */     this.RWingB.addBox(-0.5F, -3.0F, 0.0F, 1, 4, 14);
/*      */     this.RWingB.setRotationPoint(-4.0F, 4.0F, -3.0F);
/*      */     setRotation(this.RWingB, 0.0872665F, -0.0872665F, 0.0F);
/*      */     this.RWingC = new ModelRenderer(this, 98, 0);
/*      */     this.RWingC.addBox(0.0F, 0.0F, 0.0F, 1, 4, 14);
/*      */     this.RWingC.setRotationPoint(-4.0F, 4.0F, -3.0F);
/*      */     setRotation(this.RWingC, 0.0F, -0.0872665F, 0.0F);
/*      */     this.RWingD = new ModelRenderer(this, 26, 80);
/*      */     this.RWingD.addBox(-15.0F, -1.0F, -1.0F, 15, 2, 2);
/*      */     this.RWingD.setRotationPoint(-4.0F, 3.0F, -3.0F);
/*      */     setRotation(this.RWingD, 0.0F, 0.0F, 0.3490659F);
/*      */     this.RWingE = new ModelRenderer(this, 0, 88);
/*      */     this.RWingE.addBox(-15.0F, 0.0F, 1.0F, 15, 0, 15);
/*      */     this.RWingE.setRotationPoint(-4.0F, 3.0F, -3.0F);
/*      */     setRotation(this.RWingE, 0.0F, 0.0F, 0.3490659F);
/*      */     this.SaddleA = new ModelRenderer(this, 72, 18);
/*      */     this.SaddleA.addBox(-4.0F, 0.5F, -3.0F, 8, 1, 8);
/*      */     this.SaddleA.setRotationPoint(0.0F, 0.0F, 0.0F);
/*      */     this.SaddleB = new ModelRenderer(this, 72, 27);
/*      */     this.SaddleB.addBox(-1.5F, 0.0F, -3.0F, 3, 1, 2);
/*      */     this.SaddleB.setRotationPoint(0.0F, 0.0F, 0.0F);
/*      */     this.SaddleL = new ModelRenderer(this, 72, 30);
/*      */     this.SaddleL.addBox(-0.5F, 0.0F, -0.5F, 1, 6, 1);
/*      */     this.SaddleL.setRotationPoint(4.0F, 1.0F, 0.0F);
/*      */     this.SaddleR = new ModelRenderer(this, 84, 30);
/*      */     this.SaddleR.addBox(-0.5F, 0.0F, -0.5F, 1, 6, 1);
/*      */     this.SaddleR.setRotationPoint(-4.0F, 1.0F, 0.0F);
/*      */     this.SaddleL2 = new ModelRenderer(this, 76, 30);
/*      */     this.SaddleL2.addBox(-0.5F, 6.0F, -1.0F, 1, 2, 2);
/*      */     this.SaddleL2.setRotationPoint(4.0F, 1.0F, 0.0F);
/*      */     this.SaddleR2 = new ModelRenderer(this, 88, 30);
/*      */     this.SaddleR2.addBox(-0.5F, 6.0F, -1.0F, 1, 2, 2);
/*      */     this.SaddleR2.setRotationPoint(-4.0F, 1.0F, 0.0F);
/*      */     this.SaddleC = new ModelRenderer(this, 84, 27);
/*      */     this.SaddleC.addBox(-4.0F, 0.0F, 3.0F, 8, 1, 2);
/*      */     this.SaddleC.setRotationPoint(0.0F, 0.0F, 0.0F);
/*      */     this.NeckLFeather = new ModelRenderer(this, 8, 73);
/*      */     this.NeckLFeather.addBox(0.0F, -8.0F, -0.5F, 0, 7, 4);
/*      */     this.NeckLFeather.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.NeckLFeather, 0.2007129F, 0.0F, 0.0F);
/*      */     this.NeckUFeather = new ModelRenderer(this, 0, 73);
/*      */     this.NeckUFeather.addBox(0.0F, -16.0F, -2.0F, 0, 9, 4);
/*      */     this.NeckUFeather.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.NeckD = new ModelRenderer(this, 0, 16);
/*      */     this.NeckD.addBox(-1.5F, -4.0F, -2.0F, 3, 8, 3);
/*      */     this.NeckD.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.NeckD, 0.4363323F, 0.0F, 0.0F);
/*      */     this.Saddlebag = new ModelRenderer(this, 32, 7);
/*      */     this.Saddlebag.addBox(-4.5F, -3.0F, 5.0F, 9, 4, 7);
/*      */     this.Saddlebag.setRotationPoint(0.0F, 0.0F, 0.0F);
/*      */     setRotation(this.Saddlebag, -0.2602503F, 0.0F, 0.0F);
/*      */     this.Flagpole = new ModelRenderer(this, 28, 0);
/*      */     this.Flagpole.addBox(-0.5F, -15.0F, -0.5F, 1, 17, 1);
/*      */     this.Flagpole.setRotationPoint(0.0F, 0.0F, 5.0F);
/*      */     setRotation(this.Flagpole, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagBlack = new ModelRenderer(this, 108, 8);
/*      */     this.FlagBlack.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagBlack.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagBlack, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagDarkGrey = new ModelRenderer(this, 108, 12);
/*      */     this.FlagDarkGrey.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagDarkGrey.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagDarkGrey, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagYellow = new ModelRenderer(this, 48, 46);
/*      */     this.FlagYellow.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagYellow.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagYellow, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagBrown = new ModelRenderer(this, 48, 42);
/*      */     this.FlagBrown.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagBrown.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagBrown, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagGreen = new ModelRenderer(this, 48, 38);
/*      */     this.FlagGreen.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagGreen.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagGreen, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagCyan = new ModelRenderer(this, 48, 50);
/*      */     this.FlagCyan.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagCyan.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagCyan, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagLightBlue = new ModelRenderer(this, 68, 32);
/*      */     this.FlagLightBlue.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagLightBlue.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagLightBlue, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagDarkBlue = new ModelRenderer(this, 68, 28);
/*      */     this.FlagDarkBlue.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagDarkBlue.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagDarkBlue, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagPurple = new ModelRenderer(this, 88, 32);
/*      */     this.FlagPurple.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagPurple.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagPurple, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagDarkPurple = new ModelRenderer(this, 88, 28);
/*      */     this.FlagDarkPurple.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagDarkPurple.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagDarkPurple, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagDarkGreen = new ModelRenderer(this, 108, 32);
/*      */     this.FlagDarkGreen.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagDarkGreen.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagDarkGreen, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagLightRed = new ModelRenderer(this, 108, 28);
/*      */     this.FlagLightRed.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagLightRed.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagLightRed, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagRed = new ModelRenderer(this, 108, 24);
/*      */     this.FlagRed.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagRed.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagRed, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagWhite = new ModelRenderer(this, 108, 20);
/*      */     this.FlagWhite.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagWhite.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagWhite, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagGrey = new ModelRenderer(this, 108, 16);
/*      */     this.FlagGrey.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagGrey.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagGrey, -0.2602503F, 0.0F, 0.0F);
/*      */     this.FlagOrange = new ModelRenderer(this, 88, 24);
/*      */     this.FlagOrange.addBox(0.0F, -2.1F, 0.0F, 0, 4, 10);
/*      */     this.FlagOrange.setRotationPoint(0.0F, -12.0F, 8.0F);
/*      */     setRotation(this.FlagOrange, -0.2602503F, 0.0F, 0.0F);
/*      */     this.NeckU = new ModelRenderer(this, 20, 0);
/*      */     this.NeckU.addBox(-1.0F, -12.0F, -4.0F, 2, 5, 2);
/*      */     this.NeckU.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.NeckL = new ModelRenderer(this, 20, 7);
/*      */     this.NeckL.addBox(-1.0F, -8.0F, -2.5F, 2, 5, 2);
/*      */     this.NeckL.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.NeckL, 0.2007129F, 0.0F, 0.0F);
/*      */     this.NeckHarness = new ModelRenderer(this, 0, 11);
/*      */     this.NeckHarness.addBox(-2.0F, -3.0F, -2.5F, 4, 1, 4);
/*      */     this.NeckHarness.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.NeckHarness, 0.4363323F, 0.0F, 0.0F);
/*      */     this.NeckHarness2 = new ModelRenderer(this, 84, 55);
/*      */     this.NeckHarness2.addBox(-3.0F, -2.5F, -2.0F, 6, 1, 1);
/*      */     this.NeckHarness2.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.NeckHarnessRight = new ModelRenderer(this, 84, 45);
/*      */     this.NeckHarnessRight.addBox(-2.3F, -3.5F, -0.5F, 0, 3, 12);
/*      */     this.NeckHarnessRight.setRotationPoint(0.0F, 3.0F, -6.0F);
...
/*      */     this.NeckHarnessLeft.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.NeckHarnessLeft, 0.8983798F, 0.0F, 0.0F);
/*      */     this.Head = new ModelRenderer(this, 0, 0);
/*      */     this.Head.addBox(-1.5F, -16.0F, -4.5F, 3, 4, 3);
/*      */     this.Head.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.UniHorn = new ModelRenderer(this, 0, 8);
/*      */     this.UniHorn.addBox(-0.5F, -21.0F, 0.5F, 1, 6, 1);
/*      */     this.UniHorn.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.UniHorn, 0.3171542F, 0.0F, 0.0F);
/*      */     this.HelmetLeather = new ModelRenderer(this, 66, 0);
/*      */     this.HelmetLeather.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetLeather.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetIron = new ModelRenderer(this, 84, 46);
/*      */     this.HelmetIron.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetIron.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetGold = new ModelRenderer(this, 112, 64);
/*      */     this.HelmetGold.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetGold.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetDiamond = new ModelRenderer(this, 96, 64);
/*      */     this.HelmetDiamond.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetDiamond.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetHide = new ModelRenderer(this, 96, 5);
/*      */     this.HelmetHide.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetHide.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetNeckHide = new ModelRenderer(this, 58, 0);
/*      */     this.HelmetNeckHide.addBox(-1.5F, -12.0F, -4.5F, 3, 1, 3);
/*      */     this.HelmetNeckHide.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetHideEar1 = new ModelRenderer(this, 84, 9);
/*      */     this.HelmetHideEar1.addBox(-2.5F, -18.0F, -3.0F, 2, 2, 1);
/*      */     this.HelmetHideEar1.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetHideEar2 = new ModelRenderer(this, 90, 9);
/*      */     this.HelmetHideEar2.addBox(0.5F, -18.0F, -3.0F, 2, 2, 1);
/*      */     this.HelmetHideEar2.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetFur = new ModelRenderer(this, 84, 0);
/*      */     this.HelmetFur.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetFur.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetNeckFur = new ModelRenderer(this, 96, 0);
/*      */     this.HelmetNeckFur.addBox(-1.5F, -12.0F, -4.5F, 3, 1, 3);
/*      */     this.HelmetNeckFur.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetFurEar1 = new ModelRenderer(this, 66, 9);
/*      */     this.HelmetFurEar1.addBox(-2.5F, -18.0F, -3.0F, 2, 2, 1);
/*      */     this.HelmetFurEar1.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetFurEar2 = new ModelRenderer(this, 76, 9);
/*      */     this.HelmetFurEar2.addBox(0.5F, -18.0F, -3.0F, 2, 2, 1);
/*      */     this.HelmetFurEar2.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetReptile = new ModelRenderer(this, 64, 64);
/*      */     this.HelmetReptile.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetReptile.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetReptileEar2 = new ModelRenderer(this, 114, 45);
/*      */     this.HelmetReptileEar2.addBox(2.5F, -16.5F, -2.0F, 0, 5, 5);
/*      */     this.HelmetReptileEar2.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.HelmetReptileEar2, 0.0F, 0.6108652F, 0.0F);
/*      */     this.HelmetReptileEar1 = new ModelRenderer(this, 114, 50);
/*      */     this.HelmetReptileEar1.addBox(-2.5F, -16.5F, -2.0F, 0, 5, 5);
/*      */     this.HelmetReptileEar1.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     setRotation(this.HelmetReptileEar1, 0.0F, -0.6108652F, 0.0F);
/*      */     this.HelmetGreenChitin = new ModelRenderer(this, 80, 64);
/*      */     this.HelmetGreenChitin.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetGreenChitin.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetYellowChitin = new ModelRenderer(this, 0, 64);
/*      */     this.HelmetYellowChitin.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetYellowChitin.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetBlueChitin = new ModelRenderer(this, 16, 64);
/*      */     this.HelmetBlueChitin.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetBlueChitin.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetBlackChitin = new ModelRenderer(this, 32, 64);
/*      */     this.HelmetBlackChitin.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetBlackChitin.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.HelmetRedChitin = new ModelRenderer(this, 48, 64);
/*      */     this.HelmetRedChitin.addBox(-2.0F, -16.5F, -5.0F, 4, 5, 4);
/*      */     this.HelmetRedChitin.setRotationPoint(0.0F, 3.0F, -6.0F);
/*      */     this.Tail = new ModelRenderer(this, 30, 28);
/*      */     this.Tail.addBox(-2.5F, -1.0F, 0.0F, 5, 5, 5);
/*      */     this.Tail.setRotationPoint(0.0F, 4.0F, 10.0F);
/*      */     this.Tailpart1 = new ModelRenderer(this, 30, 28);
/*      */     this.Tailpart1.addBox(-2.5F, -2.2F, 5.0F, 5, 5, 5);
/*      */     this.Tailpart1.setRotationPoint(0.0F, 4.0F, 10.0F);
/*      */     setRotation(this.Tailpart1, -0.2974289F, 0.0F, 0.0F);
/*      */     this.Tailpart2 = new ModelRenderer(this, 60, 73);
/*      */     this.Tailpart2.addBox(-2.5F, -4.3F, 9.0F, 5, 5, 8);
/*      */     this.Tailpart2.setRotationPoint(0.0F, 4.0F, 10.0F);
/*      */     setRotation(this.Tailpart2, -0.5205006F, 0.0F, 0.0F);
/*      */     this.Tailpart3 = new ModelRenderer(this, 60, 86);
/*      */     this.Tailpart3.addBox(-2.0F, 1.0F, 16.0F, 4, 4, 7);
/*      */     this.Tailpart3.setRotationPoint(0.0F, 4.0F, 10.0F);
/*      */     setRotation(this.Tailpart3, -0.2230717F, 0.0F, 0.0F);
/*      */     this.Tailpart4 = new ModelRenderer(this, 60, 97);
/*      */     this.Tailpart4.addBox(-1.5F, 8.0F, 20.6F, 3, 3, 7);
/*      */     this.Tailpart4.setRotationPoint(0.0F, 4.0F, 10.0F);
/*      */     setRotation(this.Tailpart4, 0.0743572F, 0.0F, 0.0F);
/*      */     this.Tailpart5 = new ModelRenderer(this, 60, 107);
/*      */     this.Tailpart5.addBox(-1.0F, 16.5F, 22.9F, 2, 2, 5);
/*      */     this.Tailpart5.setRotationPoint(0.0F, 4.0F, 10.0F);
...
/*      */       this.Head.rotateAngleX = RLegXRot / 20.0F + -f4 / 57.295776F;
...
/*      */       } else {
/*      */         this.Head.rotateAngleX = RLegXRot / 20.0F;
/*      */       }  
...
/*      */     this.LBeakb.rotateAngleX = 7.0F / this.radianF + this.Head.rotateAngleX;
/*      */     this.LBeakb.rotateAngleY = this.Head.rotateAngleY;
/*      */     this.LBeak2b.rotateAngleX = 7.0F / this.radianF + this.Head.rotateAngleX;
...
/*      */     this.UniHorn.rotateAngleX = 18.0F / this.radianF + this.Head.rotateAngleX;
...
/*      */     this.NeckHarness.rotateAngleX = 25.0F / this.radianF + this.Head.rotateAngleX;
...
/*      */     this.NeckHarnessLeft.rotateAngleX = 50.0F / this.radianF + this.Head.rotateAngleX;
/*      */     this.NeckHarnessLeft.rotateAngleY = this.Head.rotateAngleY;
/*      */     this.NeckHarnessRight.rotateAngleX = 50.0F / this.radianF + this.Head.rotateAngleX;
...
/*      */         this.HelmetReptileEar1.rotateAngleY = -35.0F / this.radianF + this.Head.rotateAngleY;
/*      */         this.HelmetReptileEar2.rotationPointY = this.Head.rotationPointY;
/*      */         this.HelmetReptileEar2.rotateAngleX = this.Head.rotateAngleX;
/*      */         this.HelmetReptileEar2.rotateAngleY = 35.0F / this.radianF + this.Head.rotateAngleY;
/*      */         break;
/*      */       case 8:
...
/*      */       this.LLegC.rotationPointY = 8.0F;
/*      */       this.LLegC.rotationPointZ = 17.0F;
/*      */       this.RLegC.rotationPointY = 8.0F;
/*      */       this.RLegC.rotationPointZ = 17.0F;
/*      */       this.LFoot.rotationPointY = -5.0F;
/*      */       this.LFoot.rotationPointZ = -3.0F;
/*      */       this.RFoot.rotationPointY = -5.0F;
/*      */       this.RFoot.rotationPointZ = -3.0F;
/*      */       this.LLegA.rotateAngleX = 40.0F / this.radianF;
/*      */       this.LLegB.rotateAngleX = this.LLegA.rotateAngleX;
/*      */       this.LLegC.rotateAngleX = -85.0F / this.radianF;
/*      */       this.LFoot.rotateAngleX = 25.0F / this.radianF;
/*      */       this.RLegA.rotateAngleX = 40.0F / this.radianF;
/*      */       this.RLegB.rotateAngleX = this.RLegA.rotateAngleX;
/*      */       this.RLegC.rotateAngleX = -85.0F / this.radianF;
/*      */       this.RFoot.rotateAngleX = 25.0F / this.radianF;
/*      */     } else {
/*      */       this.LLegC.rotationPointY = 5.0F;
/*      */       this.LLegC.rotationPointZ = 4.0F;
/*      */       this.RLegC.rotationPointY = 5.0F;
/*      */       this.RLegC.rotationPointZ = 4.0F;
/*      */       this.LFoot.rotationPointY = 5.0F;
/*      */       this.LFoot.rotationPointZ = 4.0F;
/*      */       this.RFoot.rotationPointY = 5.0F;
/*      */       this.RFoot.rotationPointZ = 4.0F;
...
/*      */     if (this.typeI == 5 || this.typeI == 6) {
/*      */       if (jumpCounter != 0) {
/*      */         wingF = -40.0F / this.radianF + MathHelper.cos(jumpCounter * 0.3F) * 1.3F;
/*      */       } else if (rider && floating) {
/*      */         wingF = MathHelper.cos(f2 * 0.8F) * 0.2F;
/*      */       } else {
/*      */         wingF = MathHelper.cos(f * 0.3F) * f1;
/*      */       } 
/*      */       this.LWingD.rotateAngleZ = -20.0F / this.radianF - wingF;
/*      */       this.LWingE.rotateAngleZ = -20.0F / this.radianF - wingF;
/*      */       this.RWingD.rotateAngleZ = 20.0F / this.radianF + wingF;
/*      */       this.RWingE.rotateAngleZ = 20.0F / this.radianF + wingF;
/*      */     } else {
/*      */       wingF = 10.0F / this.radianF + MathHelper.cos(f * 0.6F) * 0.2F * f1;
/*      */       if (wing)
/*      */         wingF += 0.87266463F; 
...
/*      */       this.LWingB.rotateAngleX = 0.0872665F + RLegXRot / 10.0F;
/*      */       this.LWingC.rotateAngleX = RLegXRot / 10.0F;
/*      */       this.RWingB.rotateAngleX = 0.0872665F + RLegXRot / 10.0F;
/*      */       this.RWingC.rotateAngleX = RLegXRot / 10.0F;
/*      */     } 
/*      */     if (rider) {
/*      */       this.SaddleL.rotateAngleX = -60.0F / this.radianF;
/*      */       this.SaddleL2.rotateAngleX = this.SaddleL.rotateAngleX;
/*      */       this.SaddleR.rotateAngleX = -60.0F / this.radianF;
/*      */       this.SaddleR2.rotateAngleX = this.SaddleR.rotateAngleX;
/*      */       this.SaddleL.rotateAngleZ = -40.0F / this.radianF;
/*      */       this.SaddleL2.rotateAngleZ = this.SaddleL.rotateAngleZ;
/*      */       this.SaddleR.rotateAngleZ = 40.0F / this.radianF;
...
/* Location:              C:\Users\mami\files\games\minecraft\sneakyrp\mocreatures-fix\DrZharks MoCreatures Mod-12.0.5-deobf.jar!\drzhark\mocreatures\client\model\MoCModelOstrich.class
