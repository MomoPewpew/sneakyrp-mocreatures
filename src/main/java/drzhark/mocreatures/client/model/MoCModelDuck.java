...
public class MoCModelDuck
  ...
  public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    setRotationAngles(par2, par3, par4, par5, par6, par7, fly);
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, boolean fly) {
    ...
    if (fly) {
      Float WingRot = Float.valueOf(MathHelper.cos(par3 * 1.4F + 3.141593F) * 0.6F);
      this.rightWing.rotateAngleZ = 0.5F + WingRot.floatValue();
      this.leftWing.rotateAngleZ = -0.5F - WingRot.floatValue();
    } else {
