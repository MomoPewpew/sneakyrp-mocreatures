...
/* 176 */           String swordName = ((ItemSword)stack.getItem()).getUnlocalizedName();
...
/* 182 */           String toolName = ((ItemTool)stack.getItem()).getUnlocalizedName();
...
/*     */           }
/* 186 */         } else if (stack.getItem().getUnlocalizedName().toLowerCase().contains("silver")) {
/* 187 */           i = 6.0F;
/*     */         }
/*     */       }
/*     */     }
...
/* 345 */         this.idleTime -= 100 * this.world.getDifficulty().getDifficultyId() ;
