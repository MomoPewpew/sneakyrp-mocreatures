  ...
  extends ModelBase
{
  ...
  public MoCModelKitty(float f, float f1) {
    ...
    this.headParts[0].addBox(-2.0F, -5.0F, -3.0F, 1, 1, 1, f);
    this.headParts[0].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[1] = new ModelRenderer(this, 16, 0);
    (this.headParts[1]).mirror = true;
    this.headParts[1].addBox(1.0F, -5.0F, -3.0F, 1, 1, 1, f);
    this.headParts[1].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[2] = new ModelRenderer(this, 20, 0);
    this.headParts[2].addBox(-2.5F, -4.0F, -3.0F, 2, 1, 1, f);
    this.headParts[2].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[3] = new ModelRenderer(this, 20, 0);
    (this.headParts[3]).mirror = true;
    this.headParts[3].addBox(0.5F, -4.0F, -3.0F, 2, 1, 1, f);
    this.headParts[3].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[4] = new ModelRenderer(this, 40, 0);
    this.headParts[4].addBox(-4.0F, -1.5F, -5.0F, 3, 3, 1, f);
    this.headParts[4].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[5] = new ModelRenderer(this, 40, 0);
    (this.headParts[5]).mirror = true;
    this.headParts[5].addBox(1.0F, -1.5F, -5.0F, 3, 3, 1, f);
    this.headParts[5].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[6] = new ModelRenderer(this, 21, 6);
    this.headParts[6].addBox(-1.0F, -1.0F, -5.0F, 2, 2, 1, f);
    this.headParts[6].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[7] = new ModelRenderer(this, 50, 0);
    this.headParts[7].addBox(-2.5F, 0.5F, -1.0F, 5, 4, 1, f);
    this.headParts[7].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[8] = new ModelRenderer(this, 60, 0);
    this.headParts[8].addBox(-1.5F, -2.0F, -4.1F, 3, 1, 1, f);
    this.headParts[8].setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.headParts[9] = new ModelRenderer(this, 1, 1);
    this.headParts[9].addBox(-2.5F, -3.0F, -4.0F, 5, 4, 4, f);
    this.headParts[9].setRotationPoint(0.0F, 0.0F + f1, -2.0F);

    this.body = new ModelRenderer(this, 20, 0);
    this.body.addBox(-2.5F, -2.0F, -0.0F, 5, 5, 10, f);
    this.body.setRotationPoint(0.0F, 0.0F + f1, -2.0F);
    this.rightArm = new ModelRenderer(this, 0, 9);
    this.rightArm.addBox(-1.0F, 0.0F, -1.0F, 2, 6, 2, f);
    this.rightArm.setRotationPoint(-1.5F, 3.0F + f1, -1.0F);
    this.leftArm = new ModelRenderer(this, 0, 9);
    this.leftArm.mirror = true;
    this.leftArm.addBox(-1.0F, 0.0F, -1.0F, 2, 6, 2, f);
    this.leftArm.setRotationPoint(1.5F, 3.0F + f1, -1.0F);
    this.rightLeg = new ModelRenderer(this, 8, 9);
    this.rightLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 6, 2, f);
    this.rightLeg.setRotationPoint(-1.5F, 3.0F + f1, 7.0F);
    this.leftLeg = new ModelRenderer(this, 8, 9);
    this.leftLeg.mirror = true;
    this.leftLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 6, 2, f);
    this.leftLeg.setRotationPoint(1.5F, 3.0F + f1, 7.0F);
    this.tail = new ModelRenderer(this, 16, 9);
    this.tail.mirror = true;
    this.tail.addBox(-0.5F, -8.0F, -1.0F, 1, 8, 1, f);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    if (this.isSwinging) {
      this.rightArm.rotateAngleX = -2.0F + this.swingProgress;
