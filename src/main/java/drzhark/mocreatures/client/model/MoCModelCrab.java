  ...
  extends ModelBase
{
  ...
  public MoCModelCrab() {
    ...
    this.Shell.addBox(-5.0F, 0.0F, -4.0F, 10, 4, 8);
    this.Shell.setRotationPoint(0.0F, 16.0F, 0.0F);

    this.ShellRight = new ModelRenderer(this, 0, 23);
    this.ShellRight.addBox(4.6F, -2.0F, -4.0F, 3, 3, 8);
    this.ShellRight.setRotationPoint(0.0F, 16.0F, 0.0F);
    setRotation(this.ShellRight, 0.0F, 0.0F, 0.418879F);

    this.ShellLeft = new ModelRenderer(this, 0, 12);
    this.ShellLeft.addBox(-7.6F, -2.0F, -4.0F, 3, 3, 8);
    this.ShellLeft.setRotationPoint(0.0F, 16.0F, 0.0F);
    setRotation(this.ShellLeft, 0.0F, 0.0F, -0.418879F);

    this.ShellBack = new ModelRenderer(this, 10, 42);
    this.ShellBack.addBox(-5.0F, -1.6F, 3.6F, 10, 3, 3);
    this.ShellBack.setRotationPoint(0.0F, 16.0F, 0.0F);
    setRotation(this.ShellBack, -0.418879F, 0.0F, 0.0F);

    this.LeftEye = new ModelRenderer(this, 0, 4);
    this.LeftEye.addBox(1.0F, -2.0F, -4.5F, 1, 3, 1);
    this.LeftEye.setRotationPoint(0.0F, 16.0F, 0.0F);
    setRotation(this.LeftEye, 0.0F, 0.0F, 0.1745329F);

    this.LeftEyeBase = new ModelRenderer(this, 0, 16);
    this.LeftEyeBase.addBox(1.0F, 1.0F, -5.0F, 2, 3, 1);
    this.LeftEyeBase.setRotationPoint(0.0F, 16.0F, 0.0F);
    setRotation(this.LeftEyeBase, 0.0F, 0.0F, 0.2094395F);

    this.RightEyeBase = new ModelRenderer(this, 0, 12);
    this.RightEyeBase.addBox(-3.0F, 1.0F, -5.0F, 2, 3, 1);
    this.RightEyeBase.setRotationPoint(0.0F, 16.0F, 0.0F);
    setRotation(this.RightEyeBase, 0.0F, 0.0F, -0.2094395F);

    this.RightEye = new ModelRenderer(this, 0, 0);
    this.RightEye.addBox(-2.0F, -2.0F, -4.5F, 1, 3, 1);
    this.RightEye.setRotationPoint(0.0F, 16.0F, 0.0F);
    setRotation(this.RightEye, 0.0F, 0.0F, -0.1745329F);

    this.RightArmA = new ModelRenderer(this, 0, 34);
    this.RightArmA.addBox(-4.0F, -1.0F, -1.0F, 4, 2, 2);
    this.RightArmA.setRotationPoint(-4.0F, 19.0F, -4.0F);
    setRotation(this.RightArmA, 0.0F, -0.5235988F, 0.0F);

    this.RightArmB = new ModelRenderer(this, 22, 12);
    this.RightArmB.addBox(-4.0F, -1.5F, -1.0F, 4, 3, 2);
    this.RightArmB.setRotationPoint(-4.0F, 0.0F, 0.0F);
    ...
    this.RightArmC.addBox(-3.0F, -1.5F, -1.0F, 3, 1, 2);
    this.RightArmC.setRotationPoint(-4.0F, 0.0F, 0.0F);
    this.RightArmB.addChild(this.RightArmC);

    this.RightArmD = new ModelRenderer(this, 16, 12);
    this.RightArmD.addBox(-2.0F, 0.5F, -0.5F, 2, 1, 1);
    this.RightArmD.setRotationPoint(-4.0F, 0.0F, 0.0F);
    this.RightArmB.addChild(this.RightArmD);

    this.LeftArmA = new ModelRenderer(this, 0, 38);
    this.LeftArmA.addBox(0.0F, -1.0F, -1.0F, 4, 2, 2);
    this.LeftArmA.setRotationPoint(4.0F, 19.0F, -4.0F);
    setRotation(this.LeftArmA, 0.0F, 0.5235988F, 0.0F);

    this.LeftArmB = new ModelRenderer(this, 22, 20);
    this.LeftArmB.addBox(0.0F, -1.5F, -1.0F, 4, 3, 2);
    this.LeftArmB.setRotationPoint(4.0F, 0.0F, 0.0F);
    ...
    this.LeftArmC.addBox(0.0F, -1.5F, -1.0F, 3, 1, 2);
    this.LeftArmC.setRotationPoint(4.0F, 0.0F, 0.0F);
    this.LeftArmB.addChild(this.LeftArmC);

    this.LeftArmD = new ModelRenderer(this, 16, 23);
    this.LeftArmD.addBox(0.0F, 0.5F, -0.5F, 2, 1, 1);
    this.LeftArmD.setRotationPoint(4.0F, 0.0F, 0.0F);
    this.LeftArmB.addChild(this.LeftArmD);

    this.RightLeg1A = new ModelRenderer(this, 0, 42);
    this.RightLeg1A.addBox(-4.0F, -0.5F, -0.5F, 4, 1, 1);
    this.RightLeg1A.setRotationPoint(-5.0F, 19.5F, -2.5F);
    setRotation(this.RightLeg1A, 0.0F, -0.1745329F, -0.418879F);

    this.RightLeg1B = new ModelRenderer(this, 0, 48);
    this.RightLeg1B.addBox(-4.0F, -0.5F, -0.5F, 4, 1, 1);
    this.RightLeg1B.setRotationPoint(-4.0F, 0.0F, 0.0F);
    ...
    this.RightLeg2A.addBox(-4.0F, -0.5F, -0.5F, 4, 1, 1);
    this.RightLeg2A.setRotationPoint(-5.0F, 19.5F, 0.0F);
    setRotation(this.RightLeg2A, 0.0F, 0.0872665F, -0.418879F);

    this.RightLeg2B = new ModelRenderer(this, 0, 50);
    this.RightLeg2B.addBox(-4.0F, -0.5F, -0.5F, 4, 1, 1);
    this.RightLeg2B.setRotationPoint(-4.0F, 0.0F, 0.0F);
    ...
    this.RightLeg3A.addBox(-4.0F, -0.5F, -0.5F, 4, 1, 1);
    this.RightLeg3A.setRotationPoint(-5.0F, 19.5F, 2.5F);
    setRotation(this.RightLeg3A, 0.0F, 0.6981317F, -0.418879F);

    this.RightLeg3B = new ModelRenderer(this, 0, 52);
    this.RightLeg3B.addBox(-4.0F, -0.5F, -0.5F, 4, 1, 1);
    this.RightLeg3B.setRotationPoint(-4.0F, 0.0F, 0.0F);
    ...
    this.RightLeg4A.addBox(-4.0F, -0.5F, -0.5F, 4, 1, 1);
    this.RightLeg4A.setRotationPoint(-3.0F, 19.5F, 3.5F);
    setRotation(this.RightLeg4A, 0.0F, 0.6108652F, -0.418879F);

    this.RightLeg4B = new ModelRenderer(this, 12, 36);
    this.RightLeg4B.addBox(-3.0F, -0.5F, -1.0F, 3, 1, 2);
    this.RightLeg4B.setRotationPoint(-4.0F, 0.0F, 0.0F);
    ...
    this.RightLeg4C.addBox(-3.0F, -0.5F, -1.0F, 3, 1, 2);
    this.RightLeg4C.setRotationPoint(-3.0F, 0.0F, 0.0F);
    ...
    this.LeftLeg1A.addBox(0.0F, -0.5F, -0.5F, 4, 1, 1);
    this.LeftLeg1A.setRotationPoint(5.0F, 19.5F, -2.5F);
    setRotation(this.LeftLeg1A, 0.0F, 0.1745329F, 0.418879F);

    this.LeftLeg1B = new ModelRenderer(this, 0, 56);
    this.LeftLeg1B.addBox(0.0F, -0.5F, -0.5F, 4, 1, 1);
    this.LeftLeg1B.setRotationPoint(4.0F, 0.0F, 0.0F);
    ...
    this.LeftLeg2A.addBox(0.0F, -0.5F, -0.5F, 4, 1, 1);
    this.LeftLeg2A.setRotationPoint(5.0F, 19.5F, 0.0F);
    setRotation(this.LeftLeg2A, 0.0F, -0.0872665F, 0.418879F);

    this.LeftLeg2B = new ModelRenderer(this, 10, 62);
    this.LeftLeg2B.addBox(0.0F, -0.5F, -0.5F, 4, 1, 1);
    this.LeftLeg2B.setRotationPoint(4.0F, 0.0F, 0.0F);
    ...
    this.LeftLeg3A.addBox(0.0F, -0.5F, -0.5F, 4, 1, 1);
    this.LeftLeg3A.setRotationPoint(5.0F, 19.5F, 2.5F);
    setRotation(this.LeftLeg3A, 0.0F, -0.6981317F, 0.418879F);

    this.LeftLeg3B = new ModelRenderer(this, 0, 60);
    this.LeftLeg3B.addBox(0.0F, -0.5F, -0.5F, 4, 1, 1);
    this.LeftLeg3B.setRotationPoint(4.0F, 0.0F, 0.0F);
    ...
    this.LeftLeg4A.addBox(0.0F, -0.5F, -0.5F, 4, 1, 1);
    this.LeftLeg4A.setRotationPoint(2.0F, 19.5F, 3.5F);
    setRotation(this.LeftLeg4A, 0.0F, -0.6108652F, 0.418879F);

    this.LeftLeg4B = new ModelRenderer(this, 22, 36);
    this.LeftLeg4B.addBox(0.0F, -0.5F, -1.0F, 3, 1, 2);
    this.LeftLeg4B.setRotationPoint(4.0F, 0.0F, 0.0F);
    ...
    this.LeftLeg4C.addBox(0.0F, -0.5F, -1.0F, 3, 1, 2);
    this.LeftLeg4C.setRotationPoint(3.0F, 0.0F, 0.0F);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    if (this.fleeing) {
      ...
      this.LeftArmA.rotateAngleX = -90.0F / this.radianF;
      this.RightArmA.rotateAngleX = -90.0F / this.radianF;
    } else {

      this.LeftArmA.rotateAngleX = 0.0F;
      this.RightArmA.rotateAngleX = 0.0F;
    }

    if (f1 < 0.1F) {
      this.RightArmA.rotateAngleY = -30.0F / this.radianF;
      this.RightArmB.rotateAngleY = -120.0F / this.radianF;
      ...
      float f2a = f2 % 100.0F;
      if ((((f2a > 0.0F) ? 1 : 0) & ((f2a < 10.0F) ? 1 : 0)) != 0) {
        lHand = f2a * 2.0F / this.radianF;
      }

      this.LeftArmA.rotateAngleY = 30.0F / this.radianF + lHand;
      this.LeftArmB.rotateAngleY = 120.0F / this.radianF + lHand;
      ...
      float RHand = 0.0F;
      float f2b = f2 % 75.0F;
      if ((((f2b > 30.0F) ? 1 : 0) & ((f2b < 40.0F) ? 1 : 0)) != 0) {
        RHand = (f2b - 29.0F) * 2.0F / this.radianF;
      }
      this.RightArmA.rotateAngleY = -30.0F / this.radianF - RHand;
      this.RightArmB.rotateAngleY = -120.0F / this.radianF - RHand;
    }




    float f9 = -MathHelper.cos(f * 5.0F) * f1 * 2.0F;
    float f10 = -MathHelper.cos(f * 5.0F + 3.141593F) * f1 * 2.0F;
    float f11 = -MathHelper.cos(f * 5.0F + 1.570796F) * f1 * 2.0F;
    float f12 = -MathHelper.cos(f * 5.0F + 4.712389F) * f1 * 2.0F;
    float f13 = Math.abs(MathHelper.sin(f * 0.6662F + 0.0F) * 0.4F) * f1 * 5.0F;
