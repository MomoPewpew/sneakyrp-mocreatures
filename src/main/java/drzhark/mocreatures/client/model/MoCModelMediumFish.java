  ...
  extends ModelBase
{
  ...
  public MoCModelMediumFish() {
    ...
    this.Head.addBox(-5.0F, 0.0F, -1.5F, 5, 3, 3);
    this.Head.setRotationPoint(-8.0F, 6.0F, 0.0F);
    setRotation(this.Head, 0.0F, 0.0F, -0.4461433F);

    this.LowerHead = new ModelRenderer(this, 0, 16);
    this.LowerHead.addBox(-4.0F, -3.0F, -1.5F, 4, 3, 3);
    this.LowerHead.setRotationPoint(-8.0F, 12.0F, 0.0F);
    setRotation(this.LowerHead, 0.0F, 0.0F, 0.3346075F);

    this.Nose = new ModelRenderer(this, 14, 17);
    this.Nose.addBox(-1.0F, -1.0F, -1.0F, 1, 3, 2);
    this.Nose.setRotationPoint(-11.0F, 8.2F, 0.0F);
    setRotation(this.Nose, 0.0F, 0.0F, 1.412787F);

    this.MouthBottom = new ModelRenderer(this, 16, 10);
    this.MouthBottom.addBox(-2.0F, -0.4F, -1.0F, 2, 1, 2);
    this.MouthBottom.setRotationPoint(-11.5F, 10.0F, 0.0F);
    setRotation(this.MouthBottom, 0.0F, 0.0F, 0.3346075F);

    this.MouthBottomB = new ModelRenderer(this, 16, 13);
    this.MouthBottomB.addBox(-1.5F, -2.4F, -0.5F, 1, 1, 1);
    this.MouthBottomB.setRotationPoint(-11.5F, 10.0F, 0.0F);
    setRotation(this.MouthBottomB, 0.0F, 0.0F, -0.7132579F);

    this.Body = new ModelRenderer(this, 0, 0);
    this.Body.addBox(0.0F, -3.0F, -2.0F, 9, 6, 4);
    this.Body.setRotationPoint(-8.0F, 9.0F, 0.0F);

    this.BackUp = new ModelRenderer(this, 26, 0);
    this.BackUp.addBox(0.0F, 0.0F, -1.5F, 8, 3, 3);
    this.BackUp.setRotationPoint(1.0F, 6.0F, 0.0F);
    setRotation(this.BackUp, 0.0F, 0.0F, 0.1858931F);

    this.BackDown = new ModelRenderer(this, 26, 6);
    this.BackDown.addBox(0.0F, -3.0F, -1.5F, 8, 3, 3);
    this.BackDown.setRotationPoint(1.0F, 12.0F, 0.0F);
    setRotation(this.BackDown, 0.0F, 0.0F, -0.1919862F);

    this.Tail = new ModelRenderer(this, 48, 0);
    this.Tail.addBox(0.0F, -1.5F, -1.0F, 4, 3, 2);
    this.Tail.setRotationPoint(8.0F, 9.0F, 0.0F);

    this.TailFin = new ModelRenderer(this, 48, 5);
    this.TailFin.addBox(3.0F, -5.3F, 0.0F, 5, 11, 0);
    this.TailFin.setRotationPoint(8.0F, 9.0F, 0.0F);

    this.RightPectoralFin = new ModelRenderer(this, 28, 12);
    this.RightPectoralFin.addBox(0.0F, -2.0F, 0.0F, 5, 4, 0);
    this.RightPectoralFin.setRotationPoint(-6.5F, 10.0F, 2.0F);
    setRotation(this.RightPectoralFin, 0.0F, -0.8726646F, 0.185895F);

    this.LeftPectoralFin = new ModelRenderer(this, 38, 12);
    this.LeftPectoralFin.addBox(0.0F, -2.0F, 0.0F, 5, 4, 0);
    this.LeftPectoralFin.setRotationPoint(-6.5F, 10.0F, -2.0F);
    setRotation(this.LeftPectoralFin, 0.0F, 0.8726646F, 0.1858931F);

    this.UpperFin = new ModelRenderer(this, 0, 22);
    this.UpperFin.addBox(0.0F, -4.0F, 0.0F, 15, 4, 0);
    this.UpperFin.setRotationPoint(-7.0F, 6.0F, 0.0F);
    setRotation(this.UpperFin, 0.0F, 0.0F, 0.1047198F);

    this.LowerFin = new ModelRenderer(this, 46, 20);
    this.LowerFin.addBox(0.0F, 0.0F, 0.0F, 9, 4, 0);
    this.LowerFin.setRotationPoint(0.0F, 12.0F, 0.0F);
    setRotation(this.LowerFin, 0.0F, 0.0F, -0.1858931F);

    this.RightLowerFin = new ModelRenderer(this, 28, 16);
    this.RightLowerFin.addBox(0.0F, 0.0F, 0.0F, 9, 4, 0);
    this.RightLowerFin.setRotationPoint(-7.0F, 12.0F, 1.0F);
    setRotation(this.RightLowerFin, 0.5235988F, 0.0F, 0.0F);

    this.LeftLowerFin = new ModelRenderer(this, 46, 16);
    this.LeftLowerFin.addBox(0.0F, 0.0F, 0.0F, 9, 4, 0);
    this.LeftLowerFin.setRotationPoint(-7.0F, 12.0F, -1.0F);
    setRotation(this.LeftLowerFin, -0.5235988F, 0.0F, 0.0F);
  }
